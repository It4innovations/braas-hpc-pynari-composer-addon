...
#--------------------------------------------------------------
class VTKAnnulus(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKCoordinateFrame(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKCylinder(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKFrustum(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitBoolean(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitDataSet(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitHalo(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitPolyDataDistance(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitProjectOnPlaneDistance(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitSelectionLoop(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitSum(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitVolume(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKImplicitWindowFunction(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKPerlinNoise(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKPlane(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKPlanes(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKPlanesIntersection(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKPolyPlane(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKQuadric(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKSphere(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKSpheres(Node, PBVTK_Node):
...
#--------------------------------------------------------------
class VTKSuperquadric(Node, PBVTK_Node):
...
CATEGORIES.append( PBVTK_NodeCategory( 'ImplicitFunc', 'ImplicitFunc', items=menu_items) )