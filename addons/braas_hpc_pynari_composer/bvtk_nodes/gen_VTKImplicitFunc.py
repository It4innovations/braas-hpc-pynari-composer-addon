...
#--------------------------------------------------------------
class VTKAnnulus(Node, BVTK_Node):
...
add_class( VTKAnnulus )        
TYPENAMES.append('VTKAnnulusType' )
...
class VTKBox(Node, BVTK_Node):
    ...
    b_properties: bpy.props.BoolVectorProperty(name="", size=1, get=BVTK_Node.get_b, set=BVTK_Node.set_b) #type: ignore
...
class VTKCone(Node, BVTK_Node):
    ...
    m_IsDoubleCone: bpy.props.BoolProperty(name='IsDoubleCone', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Angle: bpy.props.FloatProperty(name='Angle', default=45.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Axis: bpy.props.FloatVectorProperty(name='Axis', default=[1.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCoordinateFrame(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Origin: bpy.props.FloatVectorProperty(name='Origin', default=[0.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_XAxis: bpy.props.FloatVectorProperty(name='XAxis', default=[1.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_YAxis: bpy.props.FloatVectorProperty(name='YAxis', default=[0.0, 1.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ZAxis: bpy.props.FloatVectorProperty(name='ZAxis', default=[0.0, 0.0, 1.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCylinder(Node, BVTK_Node):
    ...
    m_Axis: bpy.props.FloatVectorProperty(name='Axis', default=[0.0, 1.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKFrustum(Node, BVTK_Node):

    bl_idname = 'VTKFrustumType'
    bl_label  = 'vtkFrustum'
    
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HorizontalAngle: bpy.props.FloatProperty(name='HorizontalAngle', default=30.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NearPlaneDistance: bpy.props.FloatProperty(name='NearPlaneDistance', default=0.5, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalAngle: bpy.props.FloatProperty(name='VerticalAngle', default=30.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
add_class( VTKFrustum )        
TYPENAMES.append('VTKFrustumType' )
...
class VTKImplicitBoolean(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_OperationType: bpy.props.EnumProperty(name='OperationType', default="Union", items=e_OperationType_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImplicitDataSet(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutValue: bpy.props.FloatProperty(name='OutValue', default=-1e+30, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutGradient: bpy.props.FloatVectorProperty(name='OutGradient', default=[0.0, 0.0, 1.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImplicitHalo(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FadeOut: bpy.props.FloatProperty(name='FadeOut', default=0.01, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImplicitPolyDataDistance(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NoValue: bpy.props.FloatProperty(name='NoValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Tolerance: bpy.props.FloatProperty(name='Tolerance', default=1e-12, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NoClosestPoint: bpy.props.FloatVectorProperty(name='NoClosestPoint', default=[0.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NoGradient: bpy.props.FloatVectorProperty(name='NoGradient', default=[0.0, 0.0, 1.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImplicitSelectionLoop(Node, BVTK_Node):
    ...
    m_AutomaticNormalGeneration: bpy.props.BoolProperty(name='AutomaticNormalGeneration', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImplicitWindowFunction(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_WindowRange: bpy.props.FloatVectorProperty(name='WindowRange', default=[0.0, 1.0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_WindowValues: bpy.props.FloatVectorProperty(name='WindowValues', default=[0.0, 1.0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPerlinNoise(Node, BVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Amplitude: bpy.props.FloatProperty(name='Amplitude', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Frequency: bpy.props.FloatVectorProperty(name='Frequency', default=[1.0, 1.0, 1.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Phase: bpy.props.FloatVectorProperty(name='Phase', default=[0.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPlane(Node, BVTK_Node):
    ...
    m_AxisAligned: bpy.props.BoolProperty(name='AxisAligned', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
