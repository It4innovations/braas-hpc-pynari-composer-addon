...
class VTKAMREnzoParticlesReader(Node, BVTK_Node):
    ...
    m_FilterLocation: bpy.props.BoolProperty(name='FilterLocation', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_Frequency: bpy.props.IntProperty(name='Frequency', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ParticleType: bpy.props.IntProperty(name='ParticleType', default=-1, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKAMREnzoReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ConvertToCGS: bpy.props.BoolProperty(name='ConvertToCGS', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_EnableCaching: bpy.props.BoolProperty(name='EnableCaching', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKAMReXParticlesReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ParticleType: bpy.props.StringProperty(name='ParticleType', default="particles", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PlotFileName: bpy.props.StringProperty(name='PlotFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKAVSucdReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_BinaryFile: bpy.props.BoolProperty(name='BinaryFile', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKArrayDataReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_InputString: bpy.props.StringProperty(name='InputString', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKAvmeshReader(Node, BVTK_Node):

    bl_idname = 'VTKAvmeshReaderType'
    bl_label  = 'vtkAvmeshReader'
    
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_BuildConnectivityIteratively: bpy.props.BoolProperty(name='BuildConnectivityIteratively', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SurfaceOnly: bpy.props.BoolProperty(name='SurfaceOnly', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKBMPReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Allow8BitBMP: bpy.props.BoolProperty(name='Allow8BitBMP', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ScalarArrayName: bpy.props.StringProperty(name='ScalarArrayName', default="ImageFile", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataMask: bpy.props.IntProperty(name='DataMask', default=1000000000, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileDimensionality: bpy.props.IntProperty(name='FileDimensionality', default=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileNameSliceOffset: bpy.props.IntProperty(name='FileNameSliceOffset', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileNameSliceSpacing: bpy.props.IntProperty(name='FileNameSliceSpacing', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MemoryBufferLength: bpy.props.IntProperty(name='MemoryBufferLength', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_DataVOI: bpy.props.IntVectorProperty(name='DataVOI', default=[0, 0, 0, 0, 0, 0], size=6, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKBTSReader(Node, BVTK_Node):
...
class VTKBYUReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadDisplacement: bpy.props.BoolProperty(name='ReadDisplacement', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadScalar: bpy.props.BoolProperty(name='ReadScalar', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadTexture: bpy.props.BoolProperty(name='ReadTexture', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DisplacementFileName: bpy.props.StringProperty(name='DisplacementFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GeometryFileName: bpy.props.StringProperty(name='GeometryFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ScalarFileName: bpy.props.StringProperty(name='ScalarFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TextureFileName: bpy.props.StringProperty(name='TextureFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PartNumber: bpy.props.IntProperty(name='PartNumber', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKBiomTableReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllColorScalars: bpy.props.BoolProperty(name='ReadAllColorScalars', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllFields: bpy.props.BoolProperty(name='ReadAllFields', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllNormals: bpy.props.BoolProperty(name='ReadAllNormals', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllScalars: bpy.props.BoolProperty(name='ReadAllScalars', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllTCoords: bpy.props.BoolProperty(name='ReadAllTCoords', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllTensors: bpy.props.BoolProperty(name='ReadAllTensors', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllVectors: bpy.props.BoolProperty(name='ReadAllVectors', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FieldDataName: bpy.props.StringProperty(name='FieldDataName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LookupTableName: bpy.props.StringProperty(name='LookupTableName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NormalsName: bpy.props.StringProperty(name='NormalsName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ScalarsName: bpy.props.StringProperty(name='ScalarsName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TCoordsName: bpy.props.StringProperty(name='TCoordsName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TensorsName: bpy.props.StringProperty(name='TensorsName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VectorsName: bpy.props.StringProperty(name='VectorsName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCGNSFileSeriesReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IgnoreReaderTime: bpy.props.BoolProperty(name='IgnoreReaderTime', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCGNSReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CacheConnectivity: bpy.props.BoolProperty(name='CacheConnectivity', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CacheMesh: bpy.props.BoolProperty(name='CacheMesh', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CreateEachSolutionAsBlock: bpy.props.BoolProperty(name='CreateEachSolutionAsBlock', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DistributeBlocks: bpy.props.BoolProperty(name='DistributeBlocks', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DoublePrecisionMesh: bpy.props.BoolProperty(name='DoublePrecisionMesh', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IgnoreFlowSolutionPointers: bpy.props.BoolProperty(name='IgnoreFlowSolutionPointers', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LoadBndPatch: bpy.props.BoolProperty(name='LoadBndPatch', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LoadMesh: bpy.props.BoolProperty(name='LoadMesh', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LoadSurfacePatch: bpy.props.BoolProperty(name='LoadSurfacePatch', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Use3DVector: bpy.props.BoolProperty(name='Use3DVector', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseUnsteadyPattern: bpy.props.BoolProperty(name='UseUnsteadyPattern', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataLocation: bpy.props.IntProperty(name='DataLocation', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UnsteadySolutionStartTimestep: bpy.props.IntProperty(name='UnsteadySolutionStartTimestep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKCONVERGECFDCGNSReader(Node, BVTK_Node):
...
class VTKCPExodusIIInSituReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CurrentTimeStep: bpy.props.IntProperty(name='CurrentTimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKCellGridReader(Node, BVTK_Node):
...
#--------------------------------------------------------------
class VTKCesium3DTilesReader(Node, BVTK_Node):
...
#--------------------------------------------------------------
class VTKCesiumB3DMReader(Node, BVTK_Node):
...
class VTKChacoReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateEdgeWeightArrays: bpy.props.BoolProperty(name='GenerateEdgeWeightArrays', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateGlobalElementIdArray: bpy.props.BoolProperty(name='GenerateGlobalElementIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateGlobalNodeIdArray: bpy.props.BoolProperty(name='GenerateGlobalNodeIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateVertexWeightArrays: bpy.props.BoolProperty(name='GenerateVertexWeightArrays', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_BaseName: bpy.props.StringProperty(name='BaseName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCityGMLReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseTransparencyAsOpacity: bpy.props.BoolProperty(name='UseTransparencyAsOpacity', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_BeginBuildingIndex: bpy.props.IntProperty(name='BeginBuildingIndex', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_EndBuildingIndex: bpy.props.IntProperty(name='EndBuildingIndex', default=1000000000, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LOD: bpy.props.IntProperty(name='LOD', default=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfBuildings: bpy.props.IntProperty(name='NumberOfBuildings', default=1000000000, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKCompositeCellGridReader(Node, BVTK_Node):
...
class VTKDEMReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_ElevationReference: bpy.props.EnumProperty(name='ElevationReference', default="ElevationBounds", items=e_ElevationReference_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKDICOMImageReader(Node, BVTK_Node):
    ...
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DirectoryName: bpy.props.StringProperty(name='DirectoryName', default="", subtype='DIR_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKDIMACSGraphReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_EdgeAttributeArrayName: bpy.props.StringProperty(name='EdgeAttributeArrayName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VertexAttributeArrayName: bpy.props.StringProperty(name='VertexAttributeArrayName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKDelimitedTextReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_AddTabFieldDelimiter: bpy.props.BoolProperty(name='AddTabFieldDelimiter', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DetectNumericColumns: bpy.props.BoolProperty(name='DetectNumericColumns', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ForceDouble: bpy.props.BoolProperty(name='ForceDouble', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_HaveHeaders: bpy.props.BoolProperty(name='HaveHeaders', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MergeConsecutiveDelimiters: bpy.props.BoolProperty(name='MergeConsecutiveDelimiters', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputPedigreeIds: bpy.props.BoolProperty(name='OutputPedigreeIds', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TrimWhitespacePriorToNumericConversion: bpy.props.BoolProperty(name='TrimWhitespacePriorToNumericConversion', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseStringDelimiter: bpy.props.BoolProperty(name='UseStringDelimiter', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CommentCharacters: bpy.props.StringProperty(name='CommentCharacters', default="#", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FieldDelimiterCharacters: bpy.props.StringProperty(name='FieldDelimiterCharacters', default=",", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_StringDelimiter: bpy.props.StringProperty(name='StringDelimiter', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UTF8FieldDelimiters: bpy.props.StringProperty(name='UTF8FieldDelimiters', default=",", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UTF8RecordDelimiters: bpy.props.StringProperty(name='UTF8RecordDelimiters', default="\n", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UTF8StringDelimiters: bpy.props.StringProperty(name='UTF8StringDelimiters', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UnicodeCharacterSet: bpy.props.StringProperty(name='UnicodeCharacterSet', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultIntegerValue: bpy.props.IntProperty(name='DefaultIntegerValue', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaxRecords: bpy.props.IntProperty(name='MaxRecords', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PreviewNumberOfLines: bpy.props.IntProperty(name='PreviewNumberOfLines', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReplacementCharacter: bpy.props.IntProperty(name='ReplacementCharacter', default=120, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SkippedRecords: bpy.props.IntProperty(name='SkippedRecords', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultDoubleValue: bpy.props.FloatProperty(name='DefaultDoubleValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=27, get=BVTK_Node.get_b, set=BVTK_Node.set_b) #type: ignore
...
#--------------------------------------------------------------
class VTKERFReader(Node, BVTK_Node):
...
class VTKEnSight6BinaryReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ApplyTetrahedralize: bpy.props.BoolProperty(name='ApplyTetrahedralize', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ParticleCoordinatesByIndex: bpy.props.BoolProperty(name='ParticleCoordinatesByIndex', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllVariables: bpy.props.BoolProperty(name='ReadAllVariables', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CaseFileName: bpy.props.StringProperty(name='CaseFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePath: bpy.props.StringProperty(name='FilePath', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKEnSightGoldCombinedReader(Node, BVTK_Node):

    bl_idname = 'VTKEnSightGoldCombinedReaderType'
    bl_label  = 'vtkEnSightGoldCombinedReader'
    
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PartOfSOSFile: bpy.props.BoolProperty(name='PartOfSOSFile', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CaseFileName: bpy.props.StringProperty(name='CaseFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePath: bpy.props.StringProperty(name='FilePath', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKEnSightMasterServerReader(Node, BVTK_Node):
    ...
    m_FilePath: bpy.props.StringProperty(name='FilePath', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CurrentPiece: bpy.props.IntProperty(name='CurrentPiece', default=-1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKEnSightSOSGoldReader(Node, BVTK_Node):
...
class VTKExodusIIReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_AnimateModeShapes: bpy.props.BoolProperty(name='AnimateModeShapes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ApplyDisplacements: bpy.props.BoolProperty(name='ApplyDisplacements', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateFileIdArray: bpy.props.BoolProperty(name='GenerateFileIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateGlobalElementIdArray: bpy.props.BoolProperty(name='GenerateGlobalElementIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateGlobalNodeIdArray: bpy.props.BoolProperty(name='GenerateGlobalNodeIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateImplicitElementIdArray: bpy.props.BoolProperty(name='GenerateImplicitElementIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateImplicitNodeIdArray: bpy.props.BoolProperty(name='GenerateImplicitNodeIdArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateObjectIdCellArray: bpy.props.BoolProperty(name='GenerateObjectIdCellArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HasModeShapes: bpy.props.BoolProperty(name='HasModeShapes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IgnoreFileTime: bpy.props.BoolProperty(name='IgnoreFileTime', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SqueezePoints: bpy.props.BoolProperty(name='SqueezePoints', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseLegacyBlockNames: bpy.props.BoolProperty(name='UseLegacyBlockNames', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_XMLFileName: bpy.props.StringProperty(name='XMLFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DisplayType: bpy.props.IntProperty(name='DisplayType', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileId: bpy.props.IntProperty(name='FileId', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CacheSize: bpy.props.FloatProperty(name='CacheSize', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ModeShapeTime: bpy.props.FloatProperty(name='ModeShapeTime', default=-1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=22, get=BVTK_Node.get_b, set=BVTK_Node.set_b) #type: ignore
...
#--------------------------------------------------------------
class VTKFDSReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeTolerance: bpy.props.FloatProperty(name='TimeTolerance', default=1e-05, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKFLUENTCFFReader(Node, BVTK_Node):
...
class VTKFixedWidthTextReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HaveHeaders: bpy.props.BoolProperty(name='HaveHeaders', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_StripWhiteSpace: bpy.props.BoolProperty(name='StripWhiteSpace', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FieldWidth: bpy.props.IntProperty(name='FieldWidth', default=10, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKGESignaReader(Node, BVTK_Node):
    ...
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Date: bpy.props.StringProperty(name='Date', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ImageNumber: bpy.props.StringProperty(name='ImageNumber', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Modality: bpy.props.StringProperty(name='Modality', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PatientID: bpy.props.StringProperty(name='PatientID', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PatientName: bpy.props.StringProperty(name='PatientName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Series: bpy.props.StringProperty(name='Series', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Study: bpy.props.StringProperty(name='Study', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileDimensionality: bpy.props.IntProperty(name='FileDimensionality', default=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileNameSliceOffset: bpy.props.IntProperty(name='FileNameSliceOffset', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileNameSliceSpacing: bpy.props.IntProperty(name='FileNameSliceSpacing', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    b_properties: bpy.props.BoolVectorProperty(name="", size=24, get=BVTK_Node.get_b, set=BVTK_Node.set_b) #type: ignore
...
class VTKGLTFReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ApplyDeformationsToGeometry: bpy.props.BoolProperty(name='ApplyDeformationsToGeometry', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CurrentScene: bpy.props.IntProperty(name='CurrentScene', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FrameRate: bpy.props.IntProperty(name='FrameRate', default=60, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GLBStart: bpy.props.IntProperty(name='GLBStart', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKGaussianCubeReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_BScale: bpy.props.FloatProperty(name='BScale', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HBScale: bpy.props.FloatProperty(name='HBScale', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKGeoJSONReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutlinePolygons: bpy.props.BoolProperty(name='OutlinePolygons', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_StringInputMode: bpy.props.BoolProperty(name='StringInputMode', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TriangulatePolygons: bpy.props.BoolProperty(name='TriangulatePolygons', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SerializedPropertiesArrayName: bpy.props.StringProperty(name='SerializedPropertiesArrayName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_StringInput: bpy.props.StringProperty(name='StringInput', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKH5PartReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CombineVectorComponents: bpy.props.BoolProperty(name='CombineVectorComponents', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateVertexCells: bpy.props.BoolProperty(name='GenerateVertexCells', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaskOutOfTimeRangeOutput: bpy.props.BoolProperty(name='MaskOutOfTimeRangeOutput', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Xarray: bpy.props.StringProperty(name='Xarray', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Yarray: bpy.props.StringProperty(name='Yarray', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Zarray: bpy.props.StringProperty(name='Zarray', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKH5RageReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CurrentTimeStep: bpy.props.IntProperty(name='CurrentTimeStep', default=-1, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKHDFReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MergeParts: bpy.props.BoolProperty(name='MergeParts', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseCache: bpy.props.BoolProperty(name='UseCache', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaximumLevelsToReadByDefaultForAMR: bpy.props.IntProperty(name='MaximumLevelsToReadByDefaultForAMR', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Step: bpy.props.IntProperty(name='Step', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKIOSSReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ApplyDisplacements: bpy.props.BoolProperty(name='ApplyDisplacements', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Caching: bpy.props.BoolProperty(name='Caching', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ElementAndSideIds: bpy.props.BoolProperty(name='ElementAndSideIds', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateFileId: bpy.props.BoolProperty(name='GenerateFileId', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GroupNumericVectorFieldComponents: bpy.props.BoolProperty(name='GroupNumericVectorFieldComponents', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MergeExodusEntityBlocks: bpy.props.BoolProperty(name='MergeExodusEntityBlocks', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllFilesToDetermineStructure: bpy.props.BoolProperty(name='ReadAllFilesToDetermineStructure', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadGlobalFields: bpy.props.BoolProperty(name='ReadGlobalFields', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadIds: bpy.props.BoolProperty(name='ReadIds', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadQAAndInformationRecords: bpy.props.BoolProperty(name='ReadQAAndInformationRecords', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ScanForRelatedFiles: bpy.props.BoolProperty(name='ScanForRelatedFiles', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DatabaseTypeOverride: bpy.props.StringProperty(name='DatabaseTypeOverride', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FieldSuffixSeparator: bpy.props.StringProperty(name='FieldSuffixSeparator', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="0", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Selector: bpy.props.StringProperty(name='Selector', default="0", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileStride: bpy.props.IntProperty(name='FileStride', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DisplacementMagnitude: bpy.props.FloatProperty(name='DisplacementMagnitude', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileRange: bpy.props.IntVectorProperty(name='FileRange', default=[0, -1], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKISIReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Delimiter: bpy.props.StringProperty(name='Delimiter', default=";", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaxRecords: bpy.props.IntProperty(name='MaxRecords', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKLANLX3DReader(Node, BVTK_Node):

    bl_idname = 'VTKLANLX3DReaderType'
    bl_label  = 'vtkLANLX3DReader'
    
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllPieces: bpy.props.BoolProperty(name='ReadAllPieces', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKLSDynaReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DeformedMesh: bpy.props.BoolProperty(name='DeformedMesh', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DeletedCellsAsGhostArray: bpy.props.BoolProperty(name='DeletedCellsAsGhostArray', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_RemoveDeletedCells: bpy.props.BoolProperty(name='RemoveDeletedCells', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DatabaseDirectory: bpy.props.StringProperty(name='DatabaseDirectory', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="/d3plot", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_InputDeck: bpy.props.StringProperty(name='InputDeck', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKLegacyCellGridReader(Node, BVTK_Node):
...
class VTKMCubesReader(Node, BVTK_Node):
    ...
    m_Normals: bpy.props.BoolProperty(name='Normals', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LimitsFileName: bpy.props.StringProperty(name='LimitsFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="BigEndian", items=e_DataByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKMINCImageReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_RescaleRealValues: bpy.props.BoolProperty(name='RescaleRealValues', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKMPASReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IsAtmosphere: bpy.props.BoolProperty(name='IsAtmosphere', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IsZeroCentered: bpy.props.BoolProperty(name='IsZeroCentered', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ProjectLatLon: bpy.props.BoolProperty(name='ProjectLatLon', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ShowMultilayerView: bpy.props.BoolProperty(name='ShowMultilayerView', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseDimensionedArrayNames: bpy.props.BoolProperty(name='UseDimensionedArrayNames', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalDimension: bpy.props.StringProperty(name='VerticalDimension', default="nVertLevels", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LayerThickness: bpy.props.IntProperty(name='LayerThickness', default=10000, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalLevel: bpy.props.IntProperty(name='VerticalLevel', default=-1, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKMotionFXCFGReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeResolution: bpy.props.IntProperty(name='TimeResolution', default=100, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKMultiBlockPLOT3DReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_AutoDetectFormat: bpy.props.BoolProperty(name='AutoDetectFormat', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_BinaryFile: bpy.props.BoolProperty(name='BinaryFile', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DoublePrecision: bpy.props.BoolProperty(name='DoublePrecision', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ForceRead: bpy.props.BoolProperty(name='ForceRead', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HasByteCount: bpy.props.BoolProperty(name='HasByteCount', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IBlanking: bpy.props.BoolProperty(name='IBlanking', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MultiGrid: bpy.props.BoolProperty(name='MultiGrid', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PreserveIntermediateFunctions: bpy.props.BoolProperty(name='PreserveIntermediateFunctions', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TwoDimensionalGeometry: bpy.props.BoolProperty(name='TwoDimensionalGeometry', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FunctionFileName: bpy.props.StringProperty(name='FunctionFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_QFileName: bpy.props.StringProperty(name='QFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_XYZFileName: bpy.props.StringProperty(name='XYZFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ScalarFunctionNumber: bpy.props.IntProperty(name='ScalarFunctionNumber', default=100, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VectorFunctionNumber: bpy.props.IntProperty(name='VectorFunctionNumber', default=202, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Gamma: bpy.props.FloatProperty(name='Gamma', default=1.4, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_R: bpy.props.FloatProperty(name='R', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKNIFTIImageReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PlanarRGB: bpy.props.BoolProperty(name='PlanarRGB', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeAsVector: bpy.props.BoolProperty(name='TimeAsVector', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKNek5000Reader(Node, BVTK_Node):

    bl_idname = 'VTKNek5000ReaderType'
    bl_label  = 'vtkNek5000Reader'
    
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CleanGrid: bpy.props.BoolProperty(name='CleanGrid', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SpectralElementIds: bpy.props.BoolProperty(name='SpectralElementIds', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataFileName: bpy.props.StringProperty(name='DataFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKNetCDFCFReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReplaceFillValueWithNan: bpy.props.BoolProperty(name='ReplaceFillValueWithNan', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SphericalCoordinates: bpy.props.BoolProperty(name='SphericalCoordinates', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LatitudeDimensionName: bpy.props.StringProperty(name='LatitudeDimensionName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LongitudeDimensionName: bpy.props.StringProperty(name='LongitudeDimensionName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeDimensionName: bpy.props.StringProperty(name='TimeDimensionName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalDimensionName: bpy.props.StringProperty(name='VerticalDimensionName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalBias: bpy.props.FloatProperty(name='VerticalBias', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalScale: bpy.props.FloatProperty(name='VerticalScale', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_OutputType: bpy.props.EnumProperty(name='OutputType', default="Automatic", items=e_OutputType_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKNetCDFPOPReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Stride: bpy.props.IntVectorProperty(name='Stride', default=[1, 1, 1], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKNetCDFUGRIDReader(Node, BVTK_Node):

    bl_idname = 'VTKNetCDFUGRIDReaderType'
    bl_label  = 'vtkNetCDFUGRIDReader'
    
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReplaceFillValueWithNan: bpy.props.BoolProperty(name='ReplaceFillValueWithNan', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
#--------------------------------------------------------------
class VTKOFFReader(Node, BVTK_Node):
...
class VTKOMETIFFReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IgnoreColorMap: bpy.props.BoolProperty(name='IgnoreColorMap', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OriginSpecifiedFlag: bpy.props.BoolProperty(name='OriginSpecifiedFlag', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SpacingSpecifiedFlag: bpy.props.BoolProperty(name='SpacingSpecifiedFlag', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_MemoryBufferLength: bpy.props.IntProperty(name='MemoryBufferLength', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfScalarComponents: bpy.props.IntProperty(name='NumberOfScalarComponents', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OrientationType: bpy.props.IntProperty(name='OrientationType', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_DataScalarType: bpy.props.EnumProperty(name='DataScalarType', default="Short", items=e_DataScalarType_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataOrigin: bpy.props.FloatVectorProperty(name='DataOrigin', default=[0.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataSpacing: bpy.props.FloatVectorProperty(name='DataSpacing', default=[1.0, 1.0, 1.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKOMFReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ColumnMajorOrdering: bpy.props.BoolProperty(name='ColumnMajorOrdering', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_WriteOutTextures: bpy.props.BoolProperty(name='WriteOutTextures', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKOpenFOAMReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_AddDimensionsToArrayNames: bpy.props.BoolProperty(name='AddDimensionsToArrayNames', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CacheMesh: bpy.props.BoolProperty(name='CacheMesh', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CopyDataToCellZones: bpy.props.BoolProperty(name='CopyDataToCellZones', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CreateCellToPoint: bpy.props.BoolProperty(name='CreateCellToPoint', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IgnoreRestartFiles: bpy.props.BoolProperty(name='IgnoreRestartFiles', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ListTimeStepsByControlDict: bpy.props.BoolProperty(name='ListTimeStepsByControlDict', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PositionsIsIn13Format: bpy.props.BoolProperty(name='PositionsIsIn13Format', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadZones: bpy.props.BoolProperty(name='ReadZones', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_SizeAverageCellToPoint: bpy.props.BoolProperty(name='SizeAverageCellToPoint', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SkipZeroTime: bpy.props.BoolProperty(name='SkipZeroTime', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Use64BitFloats: bpy.props.BoolProperty(name='Use64BitFloats', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Use64BitLabels: bpy.props.BoolProperty(name='Use64BitLabels', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPExodusIIReader(Node, BVTK_Node):
    ...
    m_UseLegacyBlockNames: bpy.props.BoolProperty(name='UseLegacyBlockNames', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_XMLFileName: bpy.props.StringProperty(name='XMLFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DisplayType: bpy.props.IntProperty(name='DisplayType', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_DisplacementMagnitude: bpy.props.FloatProperty(name='DisplacementMagnitude', default=1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ModeShapeTime: bpy.props.FloatProperty(name='ModeShapeTime', default=-1.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VariableCacheSize: bpy.props.FloatProperty(name='VariableCacheSize', default=100.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileRange: bpy.props.IntVectorProperty(name='FileRange', default=[-1, -1], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPIOReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Float64: bpy.props.BoolProperty(name='Float64', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HyperTreeGrid: bpy.props.BoolProperty(name='HyperTreeGrid', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Tracers: bpy.props.BoolProperty(name='Tracers', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="CycleIndex", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CurrentTimeStep: bpy.props.IntProperty(name='CurrentTimeStep', default=-1, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPLYReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DuplicatePointsForFaceTexture: bpy.props.BoolProperty(name='DuplicatePointsForFaceTexture', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputStream: bpy.props.BoolProperty(name='ReadFromInputStream', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FaceTextureTolerance: bpy.props.FloatProperty(name='FaceTextureTolerance', default=9.999999974752427e-07, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPNGReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadSpacingFromFile: bpy.props.BoolProperty(name='ReadSpacingFromFile', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPOpenFOAMReader(Node, BVTK_Node):
    ...
    m_ListTimeStepsByControlDict: bpy.props.BoolProperty(name='ListTimeStepsByControlDict', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PositionsIsIn13Format: bpy.props.BoolProperty(name='PositionsIsIn13Format', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadAllFilesToDetermineStructure: bpy.props.BoolProperty(name='ReadAllFilesToDetermineStructure', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadZones: bpy.props.BoolProperty(name='ReadZones', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SequentialProcessing: bpy.props.BoolProperty(name='SequentialProcessing', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SizeAverageCellToPoint: bpy.props.BoolProperty(name='SizeAverageCellToPoint', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SkipZeroTime: bpy.props.BoolProperty(name='SkipZeroTime', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPTSReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CreateCells: bpy.props.BoolProperty(name='CreateCells', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_IncludeColorAndLuminance: bpy.props.BoolProperty(name='IncludeColorAndLuminance', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LimitReadToBounds: bpy.props.BoolProperty(name='LimitReadToBounds', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_LimitToMaxNumberOfPoints: bpy.props.BoolProperty(name='LimitToMaxNumberOfPoints', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputDataTypeIsDouble: bpy.props.BoolProperty(name='OutputDataTypeIsDouble', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaxNumberOfPoints: bpy.props.IntProperty(name='MaxNumberOfPoints', default=1000000, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadBounds: bpy.props.FloatVectorProperty(name='ReadBounds', default=[1e+30, -1e+30, 1e+30, -1e+30, 1e+30, -1e+30], size=6, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKParticleReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HasScalar: bpy.props.BoolProperty(name='HasScalar', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_FileType: bpy.props.EnumProperty(name='FileType', default="Unknown", items=e_FileType_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPhyloXMLTreeReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="TimeValue", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSEPReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ExtentSplitMode: bpy.props.IntProperty(name='ExtentSplitMode', default=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputGridDimension: bpy.props.IntProperty(name='OutputGridDimension', default=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSLACReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadExternalSurface: bpy.props.BoolProperty(name='ReadExternalSurface', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadInternalVolume: bpy.props.BoolProperty(name='ReadInternalVolume', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadMidpoints: bpy.props.BoolProperty(name='ReadMidpoints', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MeshFileName: bpy.props.StringProperty(name='MeshFileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSTLReader(Node, BVTK_Node):
    ...
    m_ScalarTags: bpy.props.BoolProperty(name='ScalarTags', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSegYReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Force2D: bpy.props.BoolProperty(name='Force2D', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_StructuredGrid: bpy.props.BoolProperty(name='StructuredGrid', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VerticalCRS: bpy.props.IntProperty(name='VerticalCRS', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_XCoordByte: bpy.props.IntProperty(name='XCoordByte', default=73, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_YCoordByte: bpy.props.IntProperty(name='YCoordByte', default=77, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_XYCoordMode: bpy.props.EnumProperty(name='XYCoordMode', default="Source", items=e_XYCoordMode_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKTecplotTableReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GeneratePedigreeIds: bpy.props.BoolProperty(name='GeneratePedigreeIds', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputPedigreeIds: bpy.props.BoolProperty(name='OutputPedigreeIds', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PedigreeIdArrayName: bpy.props.StringProperty(name='PedigreeIdArrayName', default="id", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ColumnNamesOnLine: bpy.props.IntProperty(name='ColumnNamesOnLine', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HeaderLines: bpy.props.IntProperty(name='HeaderLines', default=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaxRecords: bpy.props.IntProperty(name='MaxRecords', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SkipColumnNames: bpy.props.IntProperty(name='SkipColumnNames', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKTemporalDelimitedTextReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_AddTabFieldDelimiter: bpy.props.BoolProperty(name='AddTabFieldDelimiter', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DetectNumericColumns: bpy.props.BoolProperty(name='DetectNumericColumns', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ForceDouble: bpy.props.BoolProperty(name='ForceDouble', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GeneratePedigreeIds: bpy.props.BoolProperty(name='GeneratePedigreeIds', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HaveHeaders: bpy.props.BoolProperty(name='HaveHeaders', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MergeConsecutiveDelimiters: bpy.props.BoolProperty(name='MergeConsecutiveDelimiters', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputPedigreeIds: bpy.props.BoolProperty(name='OutputPedigreeIds', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_RemoveTimeStepColumn: bpy.props.BoolProperty(name='RemoveTimeStepColumn', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TrimWhitespacePriorToNumericConversion: bpy.props.BoolProperty(name='TrimWhitespacePriorToNumericConversion', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UseStringDelimiter: bpy.props.BoolProperty(name='UseStringDelimiter', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_CommentCharacters: bpy.props.StringProperty(name='CommentCharacters', default="#", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FieldDelimiterCharacters: bpy.props.StringProperty(name='FieldDelimiterCharacters', default=",", update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_PedigreeIdArrayName: bpy.props.StringProperty(name='PedigreeIdArrayName', default="id", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_StringDelimiter: bpy.props.StringProperty(name='StringDelimiter', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeColumnName: bpy.props.StringProperty(name='TimeColumnName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UTF8FieldDelimiters: bpy.props.StringProperty(name='UTF8FieldDelimiters', default=",", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UTF8RecordDelimiters: bpy.props.StringProperty(name='UTF8RecordDelimiters', default="\n", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UTF8StringDelimiters: bpy.props.StringProperty(name='UTF8StringDelimiters', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_UnicodeCharacterSet: bpy.props.StringProperty(name='UnicodeCharacterSet', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ReplacementCharacter: bpy.props.IntProperty(name='ReplacementCharacter', default=120, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SkippedRecords: bpy.props.IntProperty(name='SkippedRecords', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeColumnId: bpy.props.IntProperty(name='TimeColumnId', default=-1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultDoubleValue: bpy.props.FloatProperty(name='DefaultDoubleValue', default=0.0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=30, get=BVTK_Node.get_b, set=BVTK_Node.set_b) #type: ignore
...
class VTKVolume16Reader(Node, BVTK_Node):
    ...
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataMask: bpy.props.IntProperty(name='DataMask', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataDimensions: bpy.props.IntVectorProperty(name='DataDimensions', default=[0, 0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ImageRange: bpy.props.IntVectorProperty(name='ImageRange', default=[1, 1], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataOrigin: bpy.props.FloatVectorProperty(name='DataOrigin', default=[0.0, 0.0, 0.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DataSpacing: bpy.props.FloatVectorProperty(name='DataSpacing', default=[1.0, 1.0, 1.0], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKWindBladeReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Filename: bpy.props.StringProperty(name='Filename', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_SubExtent: bpy.props.IntVectorProperty(name='SubExtent', default=[1000000000, 360, 1000000000, 360, 1000000000, 360], size=6, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKXMLHierarchicalBoxDataReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaximumLevelsToReadByDefault: bpy.props.IntProperty(name='MaximumLevelsToReadByDefault', default=1, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_PieceDistribution: bpy.props.IntProperty(name='PieceDistribution', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKXMLHyperTreeGridReader(Node, BVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FixedLevel: bpy.props.IntProperty(name='FixedLevel', default=1000000000, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKXMLImageDataReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_WholeSlices: bpy.props.BoolProperty(name='WholeSlices', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="TimeValue", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0, update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKXMLTreeReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateEdgePedigreeIds: bpy.props.BoolProperty(name='GenerateEdgePedigreeIds', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateVertexPedigreeIds: bpy.props.BoolProperty(name='GenerateVertexPedigreeIds', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_MaskArrays: bpy.props.BoolProperty(name='MaskArrays', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadCharData: bpy.props.BoolProperty(name='ReadCharData', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadTagName: bpy.props.BoolProperty(name='ReadTagName', default=True, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_EdgePedigreeIdArrayName: bpy.props.StringProperty(name='EdgePedigreeIdArrayName', default="edge id", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_VertexPedigreeIdArrayName: bpy.props.StringProperty(name='VertexPedigreeIdArrayName', default="vertex id", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_XMLString: bpy.props.StringProperty(name='XMLString', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKXdmfReader(Node, BVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False, update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_DomainName: bpy.props.StringProperty(name='DomainName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH', update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=BVTK_Node.outdate_vtk_status) #type: ignore
    m_Stride: bpy.props.IntVectorProperty(name='Stride', default=[1, 1, 1], size=3, update=BVTK_Node.outdate_vtk_status) #type: ignore
