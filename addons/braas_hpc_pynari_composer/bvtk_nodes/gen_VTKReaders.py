...
class VTKAMREnzoParticlesReader(Node, PBVTK_Node):
    ...
    m_FilterLocation: bpy.props.BoolProperty(name='FilterLocation', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_Frequency: bpy.props.IntProperty(name='Frequency', default=1) #type: ignore
    m_ParticleType: bpy.props.IntProperty(name='ParticleType', default=-1) #type: ignore
...
class VTKAMREnzoReader(Node, PBVTK_Node):
    ...
    m_ConvertToCGS: bpy.props.BoolProperty(name='ConvertToCGS', default=True) #type: ignore
    m_EnableCaching: bpy.props.BoolProperty(name='EnableCaching', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
...
class VTKAMReXParticlesReader(Node, PBVTK_Node):
    ...
    m_ParticleType: bpy.props.StringProperty(name='ParticleType', default="particles") #type: ignore
    m_PlotFileName: bpy.props.StringProperty(name='PlotFileName', default="", subtype='FILE_PATH') #type: ignore
...
class VTKAVSucdReader(Node, PBVTK_Node):
    ...
    m_BinaryFile: bpy.props.BoolProperty(name='BinaryFile', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items) #type: ignore
...
class VTKArrayDataReader(Node, PBVTK_Node):
    ...
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_InputString: bpy.props.StringProperty(name='InputString', default="") #type: ignore
...
class VTKAvmeshReader(Node, PBVTK_Node):
    ...
    m_BuildConnectivityIteratively: bpy.props.BoolProperty(name='BuildConnectivityIteratively', default=False) #type: ignore
    m_SurfaceOnly: bpy.props.BoolProperty(name='SurfaceOnly', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=3, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_BuildConnectivityIteratively','m_SurfaceOnly','m_FileName',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKBMPReader(Node, PBVTK_Node):
    ...
    m_Allow8BitBMP: bpy.props.BoolProperty(name='Allow8BitBMP', default=True) #type: ignore
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    ...
    m_ScalarArrayName: bpy.props.StringProperty(name='ScalarArrayName', default="ImageFile") #type: ignore
    m_DataMask: bpy.props.IntProperty(name='DataMask', default=1000000000) #type: ignore
    m_FileDimensionality: bpy.props.IntProperty(name='FileDimensionality', default=2) #type: ignore
    m_FileNameSliceOffset: bpy.props.IntProperty(name='FileNameSliceOffset', default=0) #type: ignore
    m_FileNameSliceSpacing: bpy.props.IntProperty(name='FileNameSliceSpacing', default=1) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0) #type: ignore
    m_MemoryBufferLength: bpy.props.IntProperty(name='MemoryBufferLength', default=0) #type: ignore
    ...
    m_DataVOI: bpy.props.IntVectorProperty(name='DataVOI', default=[0, 0, 0, 0, 0, 0], size=6) #type: ignore
...
class VTKBYUReader(Node, PBVTK_Node):
    ...
    m_ReadDisplacement: bpy.props.BoolProperty(name='ReadDisplacement', default=True) #type: ignore
    m_ReadScalar: bpy.props.BoolProperty(name='ReadScalar', default=True) #type: ignore
    m_ReadTexture: bpy.props.BoolProperty(name='ReadTexture', default=True) #type: ignore
    ...
    m_PartNumber: bpy.props.IntProperty(name='PartNumber', default=0) #type: ignore
...
class VTKBiomTableReader(Node, PBVTK_Node):
    ...
    m_ReadAllColorScalars: bpy.props.BoolProperty(name='ReadAllColorScalars', default=True) #type: ignore
    m_ReadAllFields: bpy.props.BoolProperty(name='ReadAllFields', default=True) #type: ignore
    m_ReadAllNormals: bpy.props.BoolProperty(name='ReadAllNormals', default=True) #type: ignore
    m_ReadAllScalars: bpy.props.BoolProperty(name='ReadAllScalars', default=True) #type: ignore
    m_ReadAllTCoords: bpy.props.BoolProperty(name='ReadAllTCoords', default=True) #type: ignore
    m_ReadAllTensors: bpy.props.BoolProperty(name='ReadAllTensors', default=True) #type: ignore
    m_ReadAllVectors: bpy.props.BoolProperty(name='ReadAllVectors', default=True) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_FieldDataName: bpy.props.StringProperty(name='FieldDataName', default="") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_LookupTableName: bpy.props.StringProperty(name='LookupTableName', default="") #type: ignore
...
class VTKCGNSFileSeriesReader(Node, PBVTK_Node):
    ...
    m_IgnoreReaderTime: bpy.props.BoolProperty(name='IgnoreReaderTime', default=False) #type: ignore
...
class VTKCGNSReader(Node, PBVTK_Node):
    ...
    m_CacheConnectivity: bpy.props.BoolProperty(name='CacheConnectivity', default=False) #type: ignore
    m_CacheMesh: bpy.props.BoolProperty(name='CacheMesh', default=False) #type: ignore
    m_CreateEachSolutionAsBlock: bpy.props.BoolProperty(name='CreateEachSolutionAsBlock', default=True) #type: ignore
    m_DistributeBlocks: bpy.props.BoolProperty(name='DistributeBlocks', default=True) #type: ignore
    m_DoublePrecisionMesh: bpy.props.BoolProperty(name='DoublePrecisionMesh', default=True) #type: ignore
    m_IgnoreFlowSolutionPointers: bpy.props.BoolProperty(name='IgnoreFlowSolutionPointers', default=False) #type: ignore
    m_LoadBndPatch: bpy.props.BoolProperty(name='LoadBndPatch', default=False) #type: ignore
    m_LoadMesh: bpy.props.BoolProperty(name='LoadMesh', default=True) #type: ignore
    m_LoadSurfacePatch: bpy.props.BoolProperty(name='LoadSurfacePatch', default=False) #type: ignore
    m_Use3DVector: bpy.props.BoolProperty(name='Use3DVector', default=True) #type: ignore
    m_UseUnsteadyPattern: bpy.props.BoolProperty(name='UseUnsteadyPattern', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_DataLocation: bpy.props.IntProperty(name='DataLocation', default=0) #type: ignore
    m_UnsteadySolutionStartTimestep: bpy.props.IntProperty(name='UnsteadySolutionStartTimestep', default=0) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=14, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_CacheConnectivity','m_CacheMesh','m_CreateEachSolutionAsBlock','m_DistributeBlocks','m_DoublePrecisionMesh','m_IgnoreFlowSolutionPointers','m_LoadBndPatch','m_LoadMesh','m_LoadSurfacePatch','m_Use3DVector','m_UseUnsteadyPattern','m_FileName','m_DataLocation','m_UnsteadySolutionStartTimestep',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKCPExodusIIInSituReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_CurrentTimeStep: bpy.props.IntProperty(name='CurrentTimeStep', default=0) #type: ignore
...
class VTKChacoReader(Node, PBVTK_Node):
    ...
    m_GenerateEdgeWeightArrays: bpy.props.BoolProperty(name='GenerateEdgeWeightArrays', default=True) #type: ignore
    m_GenerateGlobalElementIdArray: bpy.props.BoolProperty(name='GenerateGlobalElementIdArray', default=True) #type: ignore
    m_GenerateGlobalNodeIdArray: bpy.props.BoolProperty(name='GenerateGlobalNodeIdArray', default=True) #type: ignore
    m_GenerateVertexWeightArrays: bpy.props.BoolProperty(name='GenerateVertexWeightArrays', default=True) #type: ignore
...
class VTKCityGMLReader(Node, PBVTK_Node):
    ...
    m_UseTransparencyAsOpacity: bpy.props.BoolProperty(name='UseTransparencyAsOpacity', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_BeginBuildingIndex: bpy.props.IntProperty(name='BeginBuildingIndex', default=0) #type: ignore
    m_EndBuildingIndex: bpy.props.IntProperty(name='EndBuildingIndex', default=1000000000) #type: ignore
    m_LOD: bpy.props.IntProperty(name='LOD', default=3) #type: ignore
    m_NumberOfBuildings: bpy.props.IntProperty(name='NumberOfBuildings', default=1000000000) #type: ignore
...
class VTKDEMReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    e_ElevationReference: bpy.props.EnumProperty(name='ElevationReference', default="ElevationBounds", items=e_ElevationReference_items) #type: ignore
...
class VTKDIMACSGraphReader(Node, PBVTK_Node):
    ...
    m_EdgeAttributeArrayName: bpy.props.StringProperty(name='EdgeAttributeArrayName', default="") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_VertexAttributeArrayName: bpy.props.StringProperty(name='VertexAttributeArrayName', default="") #type: ignore
...
class VTKDelimitedTextReader(Node, PBVTK_Node):
    ...
    m_AddTabFieldDelimiter: bpy.props.BoolProperty(name='AddTabFieldDelimiter', default=False) #type: ignore
    m_DetectNumericColumns: bpy.props.BoolProperty(name='DetectNumericColumns', default=False) #type: ignore
    m_ForceDouble: bpy.props.BoolProperty(name='ForceDouble', default=False) #type: ignore
    m_GeneratePedigreeIds: bpy.props.BoolProperty(name='GeneratePedigreeIds', default=True) #type: ignore
    m_HaveHeaders: bpy.props.BoolProperty(name='HaveHeaders', default=False) #type: ignore
    m_MergeConsecutiveDelimiters: bpy.props.BoolProperty(name='MergeConsecutiveDelimiters', default=False) #type: ignore
    m_OutputPedigreeIds: bpy.props.BoolProperty(name='OutputPedigreeIds', default=False) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_TrimWhitespacePriorToNumericConversion: bpy.props.BoolProperty(name='TrimWhitespacePriorToNumericConversion', default=False) #type: ignore
    m_UseStringDelimiter: bpy.props.BoolProperty(name='UseStringDelimiter', default=True) #type: ignore
    m_CommentCharacters: bpy.props.StringProperty(name='CommentCharacters', default="#") #type: ignore
    m_FieldDelimiterCharacters: bpy.props.StringProperty(name='FieldDelimiterCharacters', default=",") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    ...
    m_UTF8FieldDelimiters: bpy.props.StringProperty(name='UTF8FieldDelimiters', default=",") #type: ignore
    m_UTF8RecordDelimiters: bpy.props.StringProperty(name='UTF8RecordDelimiters', default="\n") #type: ignore
    m_UTF8StringDelimiters: bpy.props.StringProperty(name='UTF8StringDelimiters', default="") #type: ignore
    m_UnicodeCharacterSet: bpy.props.StringProperty(name='UnicodeCharacterSet', default="") #type: ignore
    m_DefaultIntegerValue: bpy.props.IntProperty(name='DefaultIntegerValue', default=0) #type: ignore
    m_MaxRecords: bpy.props.IntProperty(name='MaxRecords', default=0) #type: ignore
    m_PreviewNumberOfLines: bpy.props.IntProperty(name='PreviewNumberOfLines', default=0) #type: ignore
    m_ReplacementCharacter: bpy.props.IntProperty(name='ReplacementCharacter', default=120) #type: ignore
    m_SkippedRecords: bpy.props.IntProperty(name='SkippedRecords', default=0) #type: ignore
    m_DefaultDoubleValue: bpy.props.FloatProperty(name='DefaultDoubleValue', default=0.0) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=25, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_AddTabFieldDelimiter','m_DetectNumericColumns','m_ForceDouble','m_GeneratePedigreeIds','m_HaveHeaders','m_MergeConsecutiveDelimiters','m_OutputPedigreeIds','m_ReadFromInputString','m_TrimWhitespacePriorToNumericConversion','m_UseStringDelimiter','m_CommentCharacters','m_FieldDelimiterCharacters','m_FileName','m_PedigreeIdArrayName','m_StringDelimiter','m_UTF8FieldDelimiters','m_UTF8RecordDelimiters','m_UTF8StringDelimiters','m_UnicodeCharacterSet','m_DefaultIntegerValue','m_MaxRecords','m_PreviewNumberOfLines','m_ReplacementCharacter','m_SkippedRecords','m_DefaultDoubleValue',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKEnSight6BinaryReader(Node, PBVTK_Node):
    ...
    m_ApplyTetrahedralize: bpy.props.BoolProperty(name='ApplyTetrahedralize', default=False) #type: ignore
    m_ParticleCoordinatesByIndex: bpy.props.BoolProperty(name='ParticleCoordinatesByIndex', default=True) #type: ignore
    m_ReadAllVariables: bpy.props.BoolProperty(name='ReadAllVariables', default=True) #type: ignore
    m_CaseFileName: bpy.props.StringProperty(name='CaseFileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePath: bpy.props.StringProperty(name='FilePath', default="") #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=7, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_ApplyTetrahedralize','m_ParticleCoordinatesByIndex','m_ReadAllVariables','m_CaseFileName','m_FilePath','m_TimeValue','e_ByteOrder',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKEnSightGoldCombinedReader(Node, PBVTK_Node):
    ...
    m_PartOfSOSFile: bpy.props.BoolProperty(name='PartOfSOSFile', default=False) #type: ignore
    m_CaseFileName: bpy.props.StringProperty(name='CaseFileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePath: bpy.props.StringProperty(name='FilePath', default="") #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0) #type: ignore
    ...
    def m_properties( self ):
        return ['m_PartOfSOSFile','m_CaseFileName','m_FilePath','m_TimeValue',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKEnSightMasterServerReader(Node, PBVTK_Node):
    ...
    m_CaseFileName: bpy.props.StringProperty(name='CaseFileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePath: bpy.props.StringProperty(name='FilePath', default="") #type: ignore
    m_CurrentPiece: bpy.props.IntProperty(name='CurrentPiece', default=-1) #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items) #type: ignore
    ...
    def m_properties( self ):
        return ['m_ApplyTetrahedralize','m_ParticleCoordinatesByIndex','m_ReadAllVariables','m_CaseFileName','m_FilePath','m_CurrentPiece','m_TimeValue','e_ByteOrder',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKExodusIIReader(Node, PBVTK_Node):
    ...
    m_AnimateModeShapes: bpy.props.BoolProperty(name='AnimateModeShapes', default=True) #type: ignore
    m_ApplyDisplacements: bpy.props.BoolProperty(name='ApplyDisplacements', default=True) #type: ignore
    m_GenerateFileIdArray: bpy.props.BoolProperty(name='GenerateFileIdArray', default=True) #type: ignore
    m_GenerateGlobalElementIdArray: bpy.props.BoolProperty(name='GenerateGlobalElementIdArray', default=True) #type: ignore
    m_GenerateGlobalNodeIdArray: bpy.props.BoolProperty(name='GenerateGlobalNodeIdArray', default=True) #type: ignore
    m_GenerateImplicitElementIdArray: bpy.props.BoolProperty(name='GenerateImplicitElementIdArray', default=True) #type: ignore
    m_GenerateImplicitNodeIdArray: bpy.props.BoolProperty(name='GenerateImplicitNodeIdArray', default=True) #type: ignore
    m_GenerateObjectIdCellArray: bpy.props.BoolProperty(name='GenerateObjectIdCellArray', default=True) #type: ignore
    m_HasModeShapes: bpy.props.BoolProperty(name='HasModeShapes', default=True) #type: ignore
    m_IgnoreFileTime: bpy.props.BoolProperty(name='IgnoreFileTime', default=False) #type: ignore
    m_SqueezePoints: bpy.props.BoolProperty(name='SqueezePoints', default=True) #type: ignore
    m_UseLegacyBlockNames: bpy.props.BoolProperty(name='UseLegacyBlockNames', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_XMLFileName: bpy.props.StringProperty(name='XMLFileName', default="", subtype='FILE_PATH') #type: ignore
    m_DisplayType: bpy.props.IntProperty(name='DisplayType', default=0) #type: ignore
    m_FileId: bpy.props.IntProperty(name='FileId', default=0) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0) #type: ignore
    m_CacheSize: bpy.props.FloatProperty(name='CacheSize', default=0.0) #type: ignore
    m_DisplacementMagnitude: bpy.props.FloatProperty(name='DisplacementMagnitude', default=1.0) #type: ignore
    m_ModeShapeTime: bpy.props.FloatProperty(name='ModeShapeTime', default=-1.0) #type: ignore
...
class VTKFDSReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_TimeTolerance: bpy.props.FloatProperty(name='TimeTolerance', default=1e-05) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=2, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_FileName','m_TimeTolerance',]
    def m_connections( self ):
        return ([], ['VTK Output'], ['Stream'], []) 
...
class VTKFLUENTReader(Node, PBVTK_Node):
    ...
    def m_properties( self ):
        return ['m_CacheData','m_FileName','e_DataByteOrder',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKFixedWidthTextReader(Node, PBVTK_Node):
    ...
    m_HaveHeaders: bpy.props.BoolProperty(name='HaveHeaders', default=False) #type: ignore
    m_StripWhiteSpace: bpy.props.BoolProperty(name='StripWhiteSpace', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FieldWidth: bpy.props.IntProperty(name='FieldWidth', default=10) #type: ignore
    ...
    def m_connections( self ):
        return ([], ['VTK Output'], ['TableErrorObserver'], []) 
...
class VTKGESignaReader(Node, PBVTK_Node):
    ...
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_Date: bpy.props.StringProperty(name='Date', default="") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
    m_ImageNumber: bpy.props.StringProperty(name='ImageNumber', default="") #type: ignore
    m_Modality: bpy.props.StringProperty(name='Modality', default="") #type: ignore
    m_PatientID: bpy.props.StringProperty(name='PatientID', default="") #type: ignore
    m_PatientName: bpy.props.StringProperty(name='PatientName', default="") #type: ignore
    m_Series: bpy.props.StringProperty(name='Series', default="") #type: ignore
    m_Study: bpy.props.StringProperty(name='Study', default="") #type: ignore
    m_FileDimensionality: bpy.props.IntProperty(name='FileDimensionality', default=2) #type: ignore
    m_FileNameSliceOffset: bpy.props.IntProperty(name='FileNameSliceOffset', default=0) #type: ignore
    m_FileNameSliceSpacing: bpy.props.IntProperty(name='FileNameSliceSpacing', default=1) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0) #type: ignore
...
class VTKGLTFReader(Node, PBVTK_Node):
    ...
    m_ApplyDeformationsToGeometry: bpy.props.BoolProperty(name='ApplyDeformationsToGeometry', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_CurrentScene: bpy.props.IntProperty(name='CurrentScene', default=0) #type: ignore
    m_FrameRate: bpy.props.IntProperty(name='FrameRate', default=60) #type: ignore
    m_GLBStart: bpy.props.IntProperty(name='GLBStart', default=0) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=5, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_ApplyDeformationsToGeometry','m_FileName','m_CurrentScene','m_FrameRate','m_GLBStart',]
    def m_connections( self ):
        return ([], ['VTK Output'], ['Stream', 'URILoader'], []) 
...
class VTKGaussianCubeReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_BScale: bpy.props.FloatProperty(name='BScale', default=1.0) #type: ignore
    m_HBScale: bpy.props.FloatProperty(name='HBScale', default=1.0) #type: ignore
    ...
    def m_connections( self ):
        return ([], ['VTK Output 0', 'VTK Output 1'], [], []) 
...
class VTKGeoJSONReader(Node, PBVTK_Node):
    ...
    m_OutlinePolygons: bpy.props.BoolProperty(name='OutlinePolygons', default=False) #type: ignore
    m_StringInputMode: bpy.props.BoolProperty(name='StringInputMode', default=False) #type: ignore
    m_TriangulatePolygons: bpy.props.BoolProperty(name='TriangulatePolygons', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_SerializedPropertiesArrayName: bpy.props.StringProperty(name='SerializedPropertiesArrayName', default="") #type: ignore
    m_StringInput: bpy.props.StringProperty(name='StringInput', default="") #type: ignore
...
class VTKH5PartReader(Node, PBVTK_Node):
    ...
    m_CombineVectorComponents: bpy.props.BoolProperty(name='CombineVectorComponents', default=True) #type: ignore
    m_GenerateVertexCells: bpy.props.BoolProperty(name='GenerateVertexCells', default=True) #type: ignore
    m_MaskOutOfTimeRangeOutput: bpy.props.BoolProperty(name='MaskOutOfTimeRangeOutput', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_Xarray: bpy.props.StringProperty(name='Xarray', default="") #type: ignore
    m_Yarray: bpy.props.StringProperty(name='Yarray', default="") #type: ignore
    m_Zarray: bpy.props.StringProperty(name='Zarray', default="") #type: ignore
...
class VTKH5RageReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_CurrentTimeStep: bpy.props.IntProperty(name='CurrentTimeStep', default=-1) #type: ignore
...
class VTKHDFReader(Node, PBVTK_Node):
    ...
    m_MergeParts: bpy.props.BoolProperty(name='MergeParts', default=False) #type: ignore
    m_UseCache: bpy.props.BoolProperty(name='UseCache', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_MaximumLevelsToReadByDefaultForAMR: bpy.props.IntProperty(name='MaximumLevelsToReadByDefaultForAMR', default=0) #type: ignore
    m_Step: bpy.props.IntProperty(name='Step', default=0) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=5, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_MergeParts','m_UseCache','m_FileName','m_MaximumLevelsToReadByDefaultForAMR','m_Step',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKIOSSReader(Node, PBVTK_Node):
    ...
    m_ApplyDisplacements: bpy.props.BoolProperty(name='ApplyDisplacements', default=True) #type: ignore
    m_Caching: bpy.props.BoolProperty(name='Caching', default=False) #type: ignore
    m_ElementAndSideIds: bpy.props.BoolProperty(name='ElementAndSideIds', default=True) #type: ignore
    m_GenerateFileId: bpy.props.BoolProperty(name='GenerateFileId', default=False) #type: ignore
    m_GroupNumericVectorFieldComponents: bpy.props.BoolProperty(name='GroupNumericVectorFieldComponents', default=False) #type: ignore
    m_MergeExodusEntityBlocks: bpy.props.BoolProperty(name='MergeExodusEntityBlocks', default=False) #type: ignore
    m_ReadAllFilesToDetermineStructure: bpy.props.BoolProperty(name='ReadAllFilesToDetermineStructure', default=False) #type: ignore
    m_ReadGlobalFields: bpy.props.BoolProperty(name='ReadGlobalFields', default=True) #type: ignore
    m_ReadIds: bpy.props.BoolProperty(name='ReadIds', default=True) #type: ignore
    m_ReadQAAndInformationRecords: bpy.props.BoolProperty(name='ReadQAAndInformationRecords', default=True) #type: ignore
    m_RemoveUnusedPoints: bpy.props.BoolProperty(name='RemoveUnusedPoints', default=True) #type: ignore
    m_ScanForRelatedFiles: bpy.props.BoolProperty(name='ScanForRelatedFiles', default=True) #type: ignore
    m_DatabaseTypeOverride: bpy.props.StringProperty(name='DatabaseTypeOverride', default="") #type: ignore
    m_FieldSuffixSeparator: bpy.props.StringProperty(name='FieldSuffixSeparator', default="") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="0", subtype='FILE_PATH') #type: ignore
    m_Selector: bpy.props.StringProperty(name='Selector', default="0") #type: ignore
    m_FileStride: bpy.props.IntProperty(name='FileStride', default=1) #type: ignore
    m_DisplacementMagnitude: bpy.props.FloatProperty(name='DisplacementMagnitude', default=1.0) #type: ignore
    m_FileRange: bpy.props.IntVectorProperty(name='FileRange', default=[0, -1], size=2) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=19, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_ApplyDisplacements','m_Caching','m_ElementAndSideIds','m_GenerateFileId','m_GroupNumericVectorFieldComponents','m_MergeExodusEntityBlocks','m_ReadAllFilesToDetermineStructure','m_ReadGlobalFields','m_ReadIds','m_ReadQAAndInformationRecords','m_RemoveUnusedPoints','m_ScanForRelatedFiles','m_DatabaseTypeOverride','m_FieldSuffixSeparator','m_FileName','m_Selector','m_FileStride','m_DisplacementMagnitude','m_FileRange',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKISIReader(Node, PBVTK_Node):
    ...
    m_Delimiter: bpy.props.StringProperty(name='Delimiter', default=";") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_MaxRecords: bpy.props.IntProperty(name='MaxRecords', default=0) #type: ignore
...
class VTKLANLX3DReader(Node, PBVTK_Node):
    ...
    m_ReadAllPieces: bpy.props.BoolProperty(name='ReadAllPieces', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=2, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_ReadAllPieces','m_FileName',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKLSDynaReader(Node, PBVTK_Node):
    ...
    m_DeformedMesh: bpy.props.BoolProperty(name='DeformedMesh', default=True) #type: ignore
    m_DeletedCellsAsGhostArray: bpy.props.BoolProperty(name='DeletedCellsAsGhostArray', default=True) #type: ignore
    m_RemoveDeletedCells: bpy.props.BoolProperty(name='RemoveDeletedCells', default=True) #type: ignore
    m_DatabaseDirectory: bpy.props.StringProperty(name='DatabaseDirectory', default="") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="/d3plot", subtype='FILE_PATH') #type: ignore
    m_InputDeck: bpy.props.StringProperty(name='InputDeck', default="") #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2) #type: ignore
...
class VTKMCubesReader(Node, PBVTK_Node):
    ...
    m_Normals: bpy.props.BoolProperty(name='Normals', default=True) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_LimitsFileName: bpy.props.StringProperty(name='LimitsFileName', default="", subtype='FILE_PATH') #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="BigEndian", items=e_DataByteOrder_items) #type: ignore
...
class VTKMINCImageReader(Node, PBVTK_Node):
    ...
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True) #type: ignore
    m_RescaleRealValues: bpy.props.BoolProperty(name='RescaleRealValues', default=True) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
...
class VTKMPASReader(Node, PBVTK_Node):
    ...
    m_IsAtmosphere: bpy.props.BoolProperty(name='IsAtmosphere', default=False) #type: ignore
    m_IsZeroCentered: bpy.props.BoolProperty(name='IsZeroCentered', default=False) #type: ignore
    m_ProjectLatLon: bpy.props.BoolProperty(name='ProjectLatLon', default=False) #type: ignore
    m_ShowMultilayerView: bpy.props.BoolProperty(name='ShowMultilayerView', default=False) #type: ignore
    m_UseDimensionedArrayNames: bpy.props.BoolProperty(name='UseDimensionedArrayNames', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_VerticalDimension: bpy.props.StringProperty(name='VerticalDimension', default="nVertLevels") #type: ignore
    m_LayerThickness: bpy.props.IntProperty(name='LayerThickness', default=10000) #type: ignore
    m_VerticalLevel: bpy.props.IntProperty(name='VerticalLevel', default=-1) #type: ignore
...
class VTKMotionFXCFGReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_TimeResolution: bpy.props.IntProperty(name='TimeResolution', default=100) #type: ignore
...
class VTKMultiBlockPLOT3DReader(Node, PBVTK_Node):
    ...
    m_AutoDetectFormat: bpy.props.BoolProperty(name='AutoDetectFormat', default=True) #type: ignore
    m_BinaryFile: bpy.props.BoolProperty(name='BinaryFile', default=True) #type: ignore
    m_DoublePrecision: bpy.props.BoolProperty(name='DoublePrecision', default=True) #type: ignore
    m_ForceRead: bpy.props.BoolProperty(name='ForceRead', default=True) #type: ignore
    m_HasByteCount: bpy.props.BoolProperty(name='HasByteCount', default=True) #type: ignore
    m_IBlanking: bpy.props.BoolProperty(name='IBlanking', default=True) #type: ignore
    m_MultiGrid: bpy.props.BoolProperty(name='MultiGrid', default=True) #type: ignore
    m_PreserveIntermediateFunctions: bpy.props.BoolProperty(name='PreserveIntermediateFunctions', default=True) #type: ignore
    m_TwoDimensionalGeometry: bpy.props.BoolProperty(name='TwoDimensionalGeometry', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FunctionFileName: bpy.props.StringProperty(name='FunctionFileName', default="", subtype='FILE_PATH') #type: ignore
    m_QFileName: bpy.props.StringProperty(name='QFileName', default="", subtype='FILE_PATH') #type: ignore
    m_XYZFileName: bpy.props.StringProperty(name='XYZFileName', default="", subtype='FILE_PATH') #type: ignore
    m_ScalarFunctionNumber: bpy.props.IntProperty(name='ScalarFunctionNumber', default=100) #type: ignore
    m_VectorFunctionNumber: bpy.props.IntProperty(name='VectorFunctionNumber', default=202) #type: ignore
    m_Gamma: bpy.props.FloatProperty(name='Gamma', default=1.4) #type: ignore
    m_R: bpy.props.FloatProperty(name='R', default=1.0) #type: ignore
    e_ByteOrder: bpy.props.EnumProperty(name='ByteOrder', default="BigEndian", items=e_ByteOrder_items) #type: ignore
...
class VTKNIFTIImageReader(Node, PBVTK_Node):
    ...
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_TimeAsVector: bpy.props.BoolProperty(name='TimeAsVector', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
    m_FileDimensionality: bpy.props.IntProperty(name='FileDimensionality', default=2) #type: ignore
...
class VTKNek5000Reader(Node, PBVTK_Node):
    ...
    m_CleanGrid: bpy.props.BoolProperty(name='CleanGrid', default=True) #type: ignore
    m_SpectralElementIds: bpy.props.BoolProperty(name='SpectralElementIds', default=True) #type: ignore
    m_DataFileName: bpy.props.StringProperty(name='DataFileName', default="", subtype='FILE_PATH') #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2) #type: ignore
    ...
    def m_properties( self ):
        return ['m_CleanGrid','m_SpectralElementIds','m_DataFileName','m_FileName','m_TimeStepRange',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKNetCDFCFReader(Node, PBVTK_Node):
    ...
    m_ReplaceFillValueWithNan: bpy.props.BoolProperty(name='ReplaceFillValueWithNan', default=True) #type: ignore
    m_SphericalCoordinates: bpy.props.BoolProperty(name='SphericalCoordinates', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_LatitudeDimensionName: bpy.props.StringProperty(name='LatitudeDimensionName', default="") #type: ignore
    m_LongitudeDimensionName: bpy.props.StringProperty(name='LongitudeDimensionName', default="") #type: ignore
    m_TimeDimensionName: bpy.props.StringProperty(name='TimeDimensionName', default="") #type: ignore
    m_VerticalDimensionName: bpy.props.StringProperty(name='VerticalDimensionName', default="") #type: ignore
    m_VerticalBias: bpy.props.FloatProperty(name='VerticalBias', default=0.0) #type: ignore
    m_VerticalScale: bpy.props.FloatProperty(name='VerticalScale', default=1.0) #type: ignore
    e_OutputType: bpy.props.EnumProperty(name='OutputType', default="Automatic", items=e_OutputType_items) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=10, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_ReplaceFillValueWithNan','m_SphericalCoordinates','m_FileName','m_LatitudeDimensionName','m_LongitudeDimensionName','m_TimeDimensionName','m_VerticalDimensionName','m_VerticalBias','m_VerticalScale','e_OutputType',]
    def m_connections( self ):
        return ([], ['VTK Output'], ['Accessor'], []) 
...
class VTKNetCDFPOPReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_Stride: bpy.props.IntVectorProperty(name='Stride', default=[1, 1, 1], size=3) #type: ignore
...
class VTKNetCDFUGRIDReader(Node, PBVTK_Node):
    ...
    m_ReplaceFillValueWithNan: bpy.props.BoolProperty(name='ReplaceFillValueWithNan', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
...
class VTKOMETIFFReader(Node, PBVTK_Node):
    ...
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True) #type: ignore
    m_IgnoreColorMap: bpy.props.BoolProperty(name='IgnoreColorMap', default=False) #type: ignore
    m_OriginSpecifiedFlag: bpy.props.BoolProperty(name='OriginSpecifiedFlag', default=False) #type: ignore
    m_SpacingSpecifiedFlag: bpy.props.BoolProperty(name='SpacingSpecifiedFlag', default=False) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
    ...
    m_MemoryBufferLength: bpy.props.IntProperty(name='MemoryBufferLength', default=0) #type: ignore
    m_NumberOfScalarComponents: bpy.props.IntProperty(name='NumberOfScalarComponents', default=1) #type: ignore
    m_OrientationType: bpy.props.IntProperty(name='OrientationType', default=1) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items) #type: ignore
    e_DataScalarType: bpy.props.EnumProperty(name='DataScalarType', default="Short", items=e_DataScalarType_items) #type: ignore
    m_DataOrigin: bpy.props.FloatVectorProperty(name='DataOrigin', default=[0.0, 0.0, 0.0], size=3) #type: ignore
    m_DataSpacing: bpy.props.FloatVectorProperty(name='DataSpacing', default=[1.0, 1.0, 1.0], size=3) #type: ignore
...
class VTKOMFReader(Node, PBVTK_Node):
    ...
    m_ColumnMajorOrdering: bpy.props.BoolProperty(name='ColumnMajorOrdering', default=False) #type: ignore
    m_WriteOutTextures: bpy.props.BoolProperty(name='WriteOutTextures', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
...
class VTKOpenFOAMReader(Node, PBVTK_Node):
    ...
    m_AddDimensionsToArrayNames: bpy.props.BoolProperty(name='AddDimensionsToArrayNames', default=True) #type: ignore
    m_CacheMesh: bpy.props.BoolProperty(name='CacheMesh', default=True) #type: ignore
    m_CopyDataToCellZones: bpy.props.BoolProperty(name='CopyDataToCellZones', default=True) #type: ignore
    m_CreateCellToPoint: bpy.props.BoolProperty(name='CreateCellToPoint', default=True) #type: ignore
    m_IgnoreRestartFiles: bpy.props.BoolProperty(name='IgnoreRestartFiles', default=True) #type: ignore
    m_ListTimeStepsByControlDict: bpy.props.BoolProperty(name='ListTimeStepsByControlDict', default=True) #type: ignore
    m_PositionsIsIn13Format: bpy.props.BoolProperty(name='PositionsIsIn13Format', default=True) #type: ignore
    m_ReadZones: bpy.props.BoolProperty(name='ReadZones', default=True) #type: ignore
    m_SequentialProcessing: bpy.props.BoolProperty(name='SequentialProcessing', default=False) #type: ignore
    m_SizeAverageCellToPoint: bpy.props.BoolProperty(name='SizeAverageCellToPoint', default=True) #type: ignore
    m_SkipZeroTime: bpy.props.BoolProperty(name='SkipZeroTime', default=False) #type: ignore
    m_Use64BitFloats: bpy.props.BoolProperty(name='Use64BitFloats', default=True) #type: ignore
    m_Use64BitLabels: bpy.props.BoolProperty(name='Use64BitLabels', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_TimeValue: bpy.props.FloatProperty(name='TimeValue', default=0.0) #type: ignore
    ...
    def m_properties( self ):
        return ['m_AddDimensionsToArrayNames','m_CacheMesh','m_CopyDataToCellZones','m_CreateCellToPoint','m_IgnoreRestartFiles','m_ListTimeStepsByControlDict','m_PositionsIsIn13Format','m_ReadZones','m_SequentialProcessing','m_SizeAverageCellToPoint','m_SkipZeroTime','m_Use64BitFloats','m_Use64BitLabels','m_FileName','m_TimeValue',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKPExodusIIReader(Node, PBVTK_Node):
    ...
    m_UseLegacyBlockNames: bpy.props.BoolProperty(name='UseLegacyBlockNames', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
    m_XMLFileName: bpy.props.StringProperty(name='XMLFileName', default="", subtype='FILE_PATH') #type: ignore
    m_DisplayType: bpy.props.IntProperty(name='DisplayType', default=0) #type: ignore
    m_FileId: bpy.props.IntProperty(name='FileId', default=0) #type: ignore
    ...
    m_DisplacementMagnitude: bpy.props.FloatProperty(name='DisplacementMagnitude', default=1.0) #type: ignore
    m_ModeShapeTime: bpy.props.FloatProperty(name='ModeShapeTime', default=-1.0) #type: ignore
    m_VariableCacheSize: bpy.props.FloatProperty(name='VariableCacheSize', default=100.0) #type: ignore
    m_FileRange: bpy.props.IntVectorProperty(name='FileRange', default=[-1, -1], size=2) #type: ignore
...
class VTKPIOReader(Node, PBVTK_Node):
    ...
    m_Float64: bpy.props.BoolProperty(name='Float64', default=False) #type: ignore
    m_HyperTreeGrid: bpy.props.BoolProperty(name='HyperTreeGrid', default=False) #type: ignore
    m_Tracers: bpy.props.BoolProperty(name='Tracers', default=False) #type: ignore
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="CycleIndex") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_CurrentTimeStep: bpy.props.IntProperty(name='CurrentTimeStep', default=-1) #type: ignore
...
class VTKPLYReader(Node, PBVTK_Node):
    ...
    m_DuplicatePointsForFaceTexture: bpy.props.BoolProperty(name='DuplicatePointsForFaceTexture', default=True) #type: ignore
    m_ReadFromInputStream: bpy.props.BoolProperty(name='ReadFromInputStream', default=False) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FaceTextureTolerance: bpy.props.FloatProperty(name='FaceTextureTolerance', default=9.999999974752427e-07) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=5, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_DuplicatePointsForFaceTexture','m_ReadFromInputStream','m_ReadFromInputString','m_FileName','m_FaceTextureTolerance',]
    def m_connections( self ):
        return ([], ['VTK Output'], ['Stream'], []) 
...
class VTKPNGReader(Node, PBVTK_Node):
    ...
    m_FileLowerLeft: bpy.props.BoolProperty(name='FileLowerLeft', default=True) #type: ignore
    m_ReadSpacingFromFile: bpy.props.BoolProperty(name='ReadSpacingFromFile', default=False) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
...
class VTKPOpenFOAMReader(Node, PBVTK_Node):
    ...
    m_ListTimeStepsByControlDict: bpy.props.BoolProperty(name='ListTimeStepsByControlDict', default=True) #type: ignore
    m_PositionsIsIn13Format: bpy.props.BoolProperty(name='PositionsIsIn13Format', default=True) #type: ignore
    m_ReadAllFilesToDetermineStructure: bpy.props.BoolProperty(name='ReadAllFilesToDetermineStructure', default=True) #type: ignore
    m_ReadZones: bpy.props.BoolProperty(name='ReadZones', default=True) #type: ignore
    m_SequentialProcessing: bpy.props.BoolProperty(name='SequentialProcessing', default=False) #type: ignore
    m_SizeAverageCellToPoint: bpy.props.BoolProperty(name='SizeAverageCellToPoint', default=True) #type: ignore
    m_SkipZeroTime: bpy.props.BoolProperty(name='SkipZeroTime', default=False) #type: ignore
    ...
    def m_properties( self ):
        return ['m_AddDimensionsToArrayNames','m_CacheMesh','m_CopyDataToCellZones','m_CreateCellToPoint','m_IgnoreRestartFiles','m_ListTimeStepsByControlDict','m_PositionsIsIn13Format','m_ReadAllFilesToDetermineStructure','m_ReadZones','m_SequentialProcessing','m_SizeAverageCellToPoint','m_SkipZeroTime','m_Use64BitFloats','m_Use64BitLabels','m_FileName','m_TimeValue',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKPTSReader(Node, PBVTK_Node):
    ...
    m_CreateCells: bpy.props.BoolProperty(name='CreateCells', default=True) #type: ignore
    m_IncludeColorAndLuminance: bpy.props.BoolProperty(name='IncludeColorAndLuminance', default=True) #type: ignore
    m_LimitReadToBounds: bpy.props.BoolProperty(name='LimitReadToBounds', default=False) #type: ignore
    m_LimitToMaxNumberOfPoints: bpy.props.BoolProperty(name='LimitToMaxNumberOfPoints', default=False) #type: ignore
    m_OutputDataTypeIsDouble: bpy.props.BoolProperty(name='OutputDataTypeIsDouble', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_MaxNumberOfPoints: bpy.props.IntProperty(name='MaxNumberOfPoints', default=1000000) #type: ignore
    m_ReadBounds: bpy.props.FloatVectorProperty(name='ReadBounds', default=[1e+30, -1e+30, 1e+30, -1e+30, 1e+30, -1e+30], size=6) #type: ignore
...
class VTKParticleReader(Node, PBVTK_Node):
    ...
    m_HasScalar: bpy.props.BoolProperty(name='HasScalar', default=True) #type: ignore
    m_SwapBytes: bpy.props.BoolProperty(name='SwapBytes', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items) #type: ignore
    e_FileType: bpy.props.EnumProperty(name='FileType', default="Unknown", items=e_FileType_items) #type: ignore
...
class VTKPhyloXMLTreeReader(Node, PBVTK_Node):
    ...
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="TimeValue") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2) #type: ignore
    ...
    def m_connections( self ):
        return ([], ['VTK Output'], ['ReaderErrorObserver'], []) 
...
class VTKSEPReader(Node, PBVTK_Node):
    ...
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_ExtentSplitMode: bpy.props.IntProperty(name='ExtentSplitMode', default=3) #type: ignore
    m_OutputGridDimension: bpy.props.IntProperty(name='OutputGridDimension', default=3) #type: ignore
...
class VTKSLACReader(Node, PBVTK_Node):
    ...
    m_ReadExternalSurface: bpy.props.BoolProperty(name='ReadExternalSurface', default=True) #type: ignore
    m_ReadInternalVolume: bpy.props.BoolProperty(name='ReadInternalVolume', default=True) #type: ignore
    m_ReadMidpoints: bpy.props.BoolProperty(name='ReadMidpoints', default=True) #type: ignore
    m_MeshFileName: bpy.props.StringProperty(name='MeshFileName', default="", subtype='FILE_PATH') #type: ignore
...
class VTKSTLReader(Node, PBVTK_Node):
    ...
    m_ScalarTags: bpy.props.BoolProperty(name='ScalarTags', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
...
class VTKSegYReader(Node, PBVTK_Node):
    ...
    m_Force2D: bpy.props.BoolProperty(name='Force2D', default=False) #type: ignore
    m_StructuredGrid: bpy.props.BoolProperty(name='StructuredGrid', default=True) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_VerticalCRS: bpy.props.IntProperty(name='VerticalCRS', default=0) #type: ignore
    m_XCoordByte: bpy.props.IntProperty(name='XCoordByte', default=73) #type: ignore
    m_YCoordByte: bpy.props.IntProperty(name='YCoordByte', default=77) #type: ignore
    e_XYCoordMode: bpy.props.EnumProperty(name='XYCoordMode', default="Source", items=e_XYCoordMode_items) #type: ignore
...
class VTKTecplotTableReader(Node, PBVTK_Node):
    ...
    m_GeneratePedigreeIds: bpy.props.BoolProperty(name='GeneratePedigreeIds', default=False) #type: ignore
    m_OutputPedigreeIds: bpy.props.BoolProperty(name='OutputPedigreeIds', default=False) #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_PedigreeIdArrayName: bpy.props.StringProperty(name='PedigreeIdArrayName', default="id") #type: ignore
    m_ColumnNamesOnLine: bpy.props.IntProperty(name='ColumnNamesOnLine', default=1) #type: ignore
    m_HeaderLines: bpy.props.IntProperty(name='HeaderLines', default=2) #type: ignore
    m_MaxRecords: bpy.props.IntProperty(name='MaxRecords', default=0) #type: ignore
    m_SkipColumnNames: bpy.props.IntProperty(name='SkipColumnNames', default=1) #type: ignore
...
class VTKTemporalDelimitedTextReader(Node, PBVTK_Node):
    ...
    m_AddTabFieldDelimiter: bpy.props.BoolProperty(name='AddTabFieldDelimiter', default=False) #type: ignore
    m_DetectNumericColumns: bpy.props.BoolProperty(name='DetectNumericColumns', default=True) #type: ignore
    m_ForceDouble: bpy.props.BoolProperty(name='ForceDouble', default=False) #type: ignore
    m_GeneratePedigreeIds: bpy.props.BoolProperty(name='GeneratePedigreeIds', default=True) #type: ignore
    m_HaveHeaders: bpy.props.BoolProperty(name='HaveHeaders', default=False) #type: ignore
    m_MergeConsecutiveDelimiters: bpy.props.BoolProperty(name='MergeConsecutiveDelimiters', default=False) #type: ignore
    m_OutputPedigreeIds: bpy.props.BoolProperty(name='OutputPedigreeIds', default=False) #type: ignore
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_RemoveTimeStepColumn: bpy.props.BoolProperty(name='RemoveTimeStepColumn', default=True) #type: ignore
    m_TrimWhitespacePriorToNumericConversion: bpy.props.BoolProperty(name='TrimWhitespacePriorToNumericConversion', default=False) #type: ignore
    m_UseStringDelimiter: bpy.props.BoolProperty(name='UseStringDelimiter', default=True) #type: ignore
    m_CommentCharacters: bpy.props.StringProperty(name='CommentCharacters', default="#") #type: ignore
    m_FieldDelimiterCharacters: bpy.props.StringProperty(name='FieldDelimiterCharacters', default=",") #type: ignore
    ...
    m_PedigreeIdArrayName: bpy.props.StringProperty(name='PedigreeIdArrayName', default="id") #type: ignore
    m_StringDelimiter: bpy.props.StringProperty(name='StringDelimiter', default="") #type: ignore
    m_TimeColumnName: bpy.props.StringProperty(name='TimeColumnName', default="") #type: ignore
    m_UTF8FieldDelimiters: bpy.props.StringProperty(name='UTF8FieldDelimiters', default=",") #type: ignore
    m_UTF8RecordDelimiters: bpy.props.StringProperty(name='UTF8RecordDelimiters', default="\n") #type: ignore
    m_UTF8StringDelimiters: bpy.props.StringProperty(name='UTF8StringDelimiters', default="") #type: ignore
    m_UnicodeCharacterSet: bpy.props.StringProperty(name='UnicodeCharacterSet', default="") #type: ignore
    ...
    m_ReplacementCharacter: bpy.props.IntProperty(name='ReplacementCharacter', default=120) #type: ignore
    m_SkippedRecords: bpy.props.IntProperty(name='SkippedRecords', default=0) #type: ignore
    m_TimeColumnId: bpy.props.IntProperty(name='TimeColumnId', default=-1) #type: ignore
    m_DefaultDoubleValue: bpy.props.FloatProperty(name='DefaultDoubleValue', default=0.0) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=28, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore

    def m_properties( self ):
        return ['m_AddTabFieldDelimiter','m_DetectNumericColumns','m_ForceDouble','m_GeneratePedigreeIds','m_HaveHeaders','m_MergeConsecutiveDelimiters','m_OutputPedigreeIds','m_ReadFromInputString','m_RemoveTimeStepColumn','m_TrimWhitespacePriorToNumericConversion','m_UseStringDelimiter','m_CommentCharacters','m_FieldDelimiterCharacters','m_FileName','m_PedigreeIdArrayName','m_StringDelimiter','m_TimeColumnName','m_UTF8FieldDelimiters','m_UTF8RecordDelimiters','m_UTF8StringDelimiters','m_UnicodeCharacterSet','m_DefaultIntegerValue','m_MaxRecords','m_PreviewNumberOfLines','m_ReplacementCharacter','m_SkippedRecords','m_TimeColumnId','m_DefaultDoubleValue',]
    def m_connections( self ):
        return ([], ['VTK Output'], [], []) 
...
class VTKVolume16Reader(Node, PBVTK_Node):
    ...
    m_FilePattern: bpy.props.StringProperty(name='FilePattern', default="%s.%d") #type: ignore
    m_FilePrefix: bpy.props.StringProperty(name='FilePrefix', default="") #type: ignore
    m_DataMask: bpy.props.IntProperty(name='DataMask', default=0) #type: ignore
    m_HeaderSize: bpy.props.IntProperty(name='HeaderSize', default=0) #type: ignore
    e_DataByteOrder: bpy.props.EnumProperty(name='DataByteOrder', default="LittleEndian", items=e_DataByteOrder_items) #type: ignore
    m_DataDimensions: bpy.props.IntVectorProperty(name='DataDimensions', default=[0, 0], size=2) #type: ignore
    m_ImageRange: bpy.props.IntVectorProperty(name='ImageRange', default=[1, 1], size=2) #type: ignore
    m_DataOrigin: bpy.props.FloatVectorProperty(name='DataOrigin', default=[0.0, 0.0, 0.0], size=3) #type: ignore
    m_DataSpacing: bpy.props.FloatVectorProperty(name='DataSpacing', default=[1.0, 1.0, 1.0], size=3) #type: ignore
...
class VTKWindBladeReader(Node, PBVTK_Node):
    ...
    m_Filename: bpy.props.StringProperty(name='Filename', default="") #type: ignore
    m_SubExtent: bpy.props.IntVectorProperty(name='SubExtent', default=[1, 0, 8, 643, 0, 0], size=6) #type: ignore
    ...
    def m_connections( self ):
        return ([], ['VTK Output 0', 'VTK Output 1', 'VTK Output 2'], [], []) 
...
class VTKXMLHierarchicalBoxDataReader(Node, PBVTK_Node):
    ...
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="TimeValue") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_MaximumLevelsToReadByDefault: bpy.props.IntProperty(name='MaximumLevelsToReadByDefault', default=1) #type: ignore
    m_PieceDistribution: bpy.props.IntProperty(name='PieceDistribution', default=0) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2) #type: ignore
...
class VTKXMLHyperTreeGridReader(Node, PBVTK_Node):
    ...
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="TimeValue") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_FixedLevel: bpy.props.IntProperty(name='FixedLevel', default=1000000000) #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2) #type: ignore
...
class VTKXMLImageDataReader(Node, PBVTK_Node):
    ...
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_WholeSlices: bpy.props.BoolProperty(name='WholeSlices', default=True) #type: ignore
    m_ActiveTimeDataArrayName: bpy.props.StringProperty(name='ActiveTimeDataArrayName', default="TimeValue") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_TimeStep: bpy.props.IntProperty(name='TimeStep', default=0) #type: ignore
    m_TimeStepRange: bpy.props.IntVectorProperty(name='TimeStepRange', default=[0, 0], size=2) #type: ignore
...
class VTKXMLTreeReader(Node, PBVTK_Node):
    ...
    m_GenerateEdgePedigreeIds: bpy.props.BoolProperty(name='GenerateEdgePedigreeIds', default=True) #type: ignore
    m_GenerateVertexPedigreeIds: bpy.props.BoolProperty(name='GenerateVertexPedigreeIds', default=True) #type: ignore
    m_MaskArrays: bpy.props.BoolProperty(name='MaskArrays', default=False) #type: ignore
    m_ReadCharData: bpy.props.BoolProperty(name='ReadCharData', default=False) #type: ignore
    m_ReadTagName: bpy.props.BoolProperty(name='ReadTagName', default=True) #type: ignore
    m_EdgePedigreeIdArrayName: bpy.props.StringProperty(name='EdgePedigreeIdArrayName', default="edge id") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_VertexPedigreeIdArrayName: bpy.props.StringProperty(name='VertexPedigreeIdArrayName', default="vertex id") #type: ignore
    m_XMLString: bpy.props.StringProperty(name='XMLString', default="") #type: ignore
...
class VTKXdmfReader(Node, PBVTK_Node):
    ...
    m_ReadFromInputString: bpy.props.BoolProperty(name='ReadFromInputString', default=False) #type: ignore
    m_DomainName: bpy.props.StringProperty(name='DomainName', default="") #type: ignore
    m_FileName: bpy.props.StringProperty(name='FileName', default="", subtype='FILE_PATH') #type: ignore
    m_Stride: bpy.props.IntVectorProperty(name='Stride', default=[1, 1, 1], size=3) #type: ignore
