...
class VTKParametricBohemianDome(Node, PBVTK_Node):
    ...
    m_ClockwiseOrdering: bpy.props.BoolProperty(name='ClockwiseOrdering', default=True) #type: ignore
    m_DerivativesAvailable: bpy.props.BoolProperty(name='DerivativesAvailable', default=True) #type: ignore
    m_JoinU: bpy.props.BoolProperty(name='JoinU', default=True) #type: ignore
    m_JoinV: bpy.props.BoolProperty(name='JoinV', default=True) #type: ignore
    m_JoinW: bpy.props.BoolProperty(name='JoinW', default=True) #type: ignore
    m_TwistU: bpy.props.BoolProperty(name='TwistU', default=True) #type: ignore
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_A: bpy.props.FloatProperty(name='A', default=0.5) #type: ignore
    m_B: bpy.props.FloatProperty(name='B', default=1.5) #type: ignore
    m_C: bpy.props.FloatProperty(name='C', default=1.0) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=3.141592653589793) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=3.141592653589793) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-3.141592653589793) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-3.141592653589793) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricBour(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=1.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=12.566370614359172) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricBoy(Node, PBVTK_Node):
    ...
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_ZScale: bpy.props.FloatProperty(name='ZScale', default=0.125) #type: ignore
...
class VTKParametricCatalanMinimal(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=12.566370614359172) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=1.5) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-12.566370614359172) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-1.5) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricConicSpiral(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_A: bpy.props.FloatProperty(name='A', default=0.2) #type: ignore
    m_B: bpy.props.FloatProperty(name='B', default=1.0) #type: ignore
    m_C: bpy.props.FloatProperty(name='C', default=0.1) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=6.283185307179586) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=6.283185307179586) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_N: bpy.props.FloatProperty(name='N', default=2.0) #type: ignore
...
class VTKParametricDini(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_A: bpy.props.FloatProperty(name='A', default=1.0) #type: ignore
    m_B: bpy.props.FloatProperty(name='B', default=0.2) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=12.566370614359172) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=2.0) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.001) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricEllipsoid(Node, PBVTK_Node):
    ...
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_XRadius: bpy.props.FloatProperty(name='XRadius', default=1.0) #type: ignore
    m_YRadius: bpy.props.FloatProperty(name='YRadius', default=1.0) #type: ignore
    m_ZRadius: bpy.props.FloatProperty(name='ZRadius', default=1.0) #type: ignore
...
class VTKParametricEnneper(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=2.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=2.0) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-2.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-2.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricHenneberg(Node, PBVTK_Node):
    ...
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=1.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=1.5707963267948966) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-1.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-1.5707963267948966) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricKuen(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_DeltaV0: bpy.props.FloatProperty(name='DeltaV0', default=0.05) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=4.5) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=3.141592653589793) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-4.5) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricMobius(Node, PBVTK_Node):
    ...
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=6.283185307179586) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=1.0) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-1.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_Radius: bpy.props.FloatProperty(name='Radius', default=1.0) #type: ignore
...
class VTKParametricPluckerConoid(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_N: bpy.props.IntProperty(name='N', default=2) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=3.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=6.283185307179586) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
...
class VTKParametricPseudosphere(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=5.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=3.141592653589793) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-5.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-3.141592653589793) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
...
class VTKParametricRandomHills(Node, PBVTK_Node):
    ...
    m_AllowRandomGeneration: bpy.props.BoolProperty(name='AllowRandomGeneration', default=True) #type: ignore
    m_ClockwiseOrdering: bpy.props.BoolProperty(name='ClockwiseOrdering', default=True) #type: ignore
    m_DerivativesAvailable: bpy.props.BoolProperty(name='DerivativesAvailable', default=True) #type: ignore
    m_JoinU: bpy.props.BoolProperty(name='JoinU', default=True) #type: ignore
    m_JoinV: bpy.props.BoolProperty(name='JoinV', default=True) #type: ignore
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_NumberOfHills: bpy.props.IntProperty(name='NumberOfHills', default=30) #type: ignore
    m_RandomSeed: bpy.props.IntProperty(name='RandomSeed', default=1) #type: ignore
    m_AmplitudeScaleFactor: bpy.props.FloatProperty(name='AmplitudeScaleFactor', default=0.3333333333333333) #type: ignore
    m_HillAmplitude: bpy.props.FloatProperty(name='HillAmplitude', default=2.0) #type: ignore
    m_HillXVariance: bpy.props.FloatProperty(name='HillXVariance', default=2.5) #type: ignore
    m_HillYVariance: bpy.props.FloatProperty(name='HillYVariance', default=2.5) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=10.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=10.0) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=-10.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-10.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_XVarianceScaleFactor: bpy.props.FloatProperty(name='XVarianceScaleFactor', default=0.3333333333333333) #type: ignore
    m_YVarianceScaleFactor: bpy.props.FloatProperty(name='YVarianceScaleFactor', default=0.3333333333333333) #type: ignore
    
    b_properties: bpy.props.BoolVectorProperty(name="", size=23, get=PBVTK_Node.get_b, set=PBVTK_Node.set_b) #type: ignore
...
class VTKParametricSpline(Node, PBVTK_Node):
    ...
    m_JoinV: bpy.props.BoolProperty(name='JoinV', default=True) #type: ignore
    m_JoinW: bpy.props.BoolProperty(name='JoinW', default=True) #type: ignore
    m_ParameterizeByLength: bpy.props.BoolProperty(name='ParameterizeByLength', default=True) #type: ignore
    m_TwistU: bpy.props.BoolProperty(name='TwistU', default=True) #type: ignore
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_LeftConstraint: bpy.props.IntProperty(name='LeftConstraint', default=1) #type: ignore
    m_RightConstraint: bpy.props.IntProperty(name='RightConstraint', default=1) #type: ignore
    m_LeftValue: bpy.props.FloatProperty(name='LeftValue', default=0.0) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=1.0) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=1.0) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=0.0) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_RightValue: bpy.props.FloatProperty(name='RightValue', default=0.0) #type: ignore
...
class VTKParametricSuperEllipsoid(Node, PBVTK_Node):
    ...
    m_MinimumV: bpy.props.FloatProperty(name='MinimumV', default=-1.5707963267948966) #type: ignore
    m_MinimumW: bpy.props.FloatProperty(name='MinimumW', default=0.0) #type: ignore
    m_N1: bpy.props.FloatProperty(name='N1', default=1.0) #type: ignore
    m_N2: bpy.props.FloatProperty(name='N2', default=1.0) #type: ignore
    m_XRadius: bpy.props.FloatProperty(name='XRadius', default=1.0) #type: ignore
    m_YRadius: bpy.props.FloatProperty(name='YRadius', default=1.0) #type: ignore
    m_ZRadius: bpy.props.FloatProperty(name='ZRadius', default=1.0) #type: ignore
...
class VTKParametricSuperToroid(Node, PBVTK_Node):
    ...
    m_TwistV: bpy.props.BoolProperty(name='TwistV', default=True) #type: ignore
    m_TwistW: bpy.props.BoolProperty(name='TwistW', default=True) #type: ignore
    m_CrossSectionRadius: bpy.props.FloatProperty(name='CrossSectionRadius', default=0.5) #type: ignore
    m_MaximumU: bpy.props.FloatProperty(name='MaximumU', default=6.283185307179586) #type: ignore
    m_MaximumV: bpy.props.FloatProperty(name='MaximumV', default=6.283185307179586) #type: ignore
    m_MaximumW: bpy.props.FloatProperty(name='MaximumW', default=1.0) #type: ignore
    m_MinimumU: bpy.props.FloatProperty(name='MinimumU', default=0.0) #type: ignore
    ...
    m_N1: bpy.props.FloatProperty(name='N1', default=1.0) #type: ignore
    m_N2: bpy.props.FloatProperty(name='N2', default=1.0) #type: ignore
    m_RingRadius: bpy.props.FloatProperty(name='RingRadius', default=1.0) #type: ignore
    m_XRadius: bpy.props.FloatProperty(name='XRadius', default=1.0) #type: ignore
    m_YRadius: bpy.props.FloatProperty(name='YRadius', default=1.0) #type: ignore
    m_ZRadius: bpy.props.FloatProperty(name='ZRadius', default=1.0) #type: ignore
