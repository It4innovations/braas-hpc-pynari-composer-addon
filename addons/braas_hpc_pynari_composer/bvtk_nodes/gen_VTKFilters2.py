...
class VTKApplyColors(Node, PBVTK_Node):
    ...
    m_ScaleCellLookupTable: bpy.props.BoolProperty(name='ScaleCellLookupTable', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ScalePointLookupTable: bpy.props.BoolProperty(name='ScalePointLookupTable', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseCellLookupTable: bpy.props.BoolProperty(name='UseCellLookupTable', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseCurrentAnnotationColor: bpy.props.BoolProperty(name='UseCurrentAnnotationColor', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UsePointLookupTable: bpy.props.BoolProperty(name='UsePointLookupTable', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CellColorOutputArrayName: bpy.props.StringProperty(name='CellColorOutputArrayName', default="vtkApplyColors color", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PointColorOutputArrayName: bpy.props.StringProperty(name='PointColorOutputArrayName', default="vtkApplyColors color", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultCellOpacity: bpy.props.FloatProperty(name='DefaultCellOpacity', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultPointOpacity: bpy.props.FloatProperty(name='DefaultPointOpacity', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectedCellOpacity: bpy.props.FloatProperty(name='SelectedCellOpacity', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectedPointOpacity: bpy.props.FloatProperty(name='SelectedPointOpacity', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultCellColor: bpy.props.FloatVectorProperty(name='DefaultCellColor', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultPointColor: bpy.props.FloatVectorProperty(name='DefaultPointColor', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectedCellColor: bpy.props.FloatVectorProperty(name='SelectedCellColor', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectedPointColor: bpy.props.FloatVectorProperty(name='SelectedPointColor', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKApplyIcons(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseLookupTable: bpy.props.BoolProperty(name='UseLookupTable', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_IconOutputArrayName: bpy.props.StringProperty(name='IconOutputArrayName', default="vtkApplyIcons icon", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AttributeType: bpy.props.IntProperty(name='AttributeType', default=4, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DefaultIcon: bpy.props.IntProperty(name='DefaultIcon', default=-1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectedIcon: bpy.props.IntProperty(name='SelectedIcon', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_SelectionMode: bpy.props.EnumProperty(name='SelectionMode', default="IgnoreSelection", items=e_SelectionMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKAreaContourSpectrumFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ArcId: bpy.props.IntProperty(name='ArcId', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_FieldId: bpy.props.IntProperty(name='FieldId', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfSamples: bpy.props.IntProperty(name='NumberOfSamples', default=100, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKBinCellDataFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComputeTolerance: bpy.props.BoolProperty(name='ComputeTolerance', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SpatialMatch: bpy.props.BoolProperty(name='SpatialMatch', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_StoreNumberOfNonzeroBins: bpy.props.BoolProperty(name='StoreNumberOfNonzeroBins', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfNonzeroBinsArrayName: bpy.props.StringProperty(name='NumberOfNonzeroBinsArrayName', default="NumberOfNonzeroBins", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ArrayComponent: bpy.props.IntProperty(name='ArrayComponent', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CellOverlapMethod: bpy.props.IntProperty(name='CellOverlapMethod', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfBins: bpy.props.IntProperty(name='NumberOfBins', default=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCellDistanceSelector(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AddIntermediate: bpy.props.BoolProperty(name='AddIntermediate', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_IncludeSeed: bpy.props.BoolProperty(name='IncludeSeed', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Distance: bpy.props.IntProperty(name='Distance', default=1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCompositeDataProbeFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CategoricalData: bpy.props.BoolProperty(name='CategoricalData', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComputeTolerance: bpy.props.BoolProperty(name='ComputeTolerance', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassCellArrays: bpy.props.BoolProperty(name='PassCellArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPartialArrays: bpy.props.BoolProperty(name='PassPartialArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SnapToCellWithClosestPoint: bpy.props.BoolProperty(name='SnapToCellWithClosestPoint', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SpatialMatch: bpy.props.BoolProperty(name='SpatialMatch', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidPointMaskArrayName: bpy.props.StringProperty(name='ValidPointMaskArrayName', default="vtkValidPointMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Tolerance: bpy.props.FloatProperty(name='Tolerance', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKConvertSelection(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AllowMissingArray: bpy.props.BoolProperty(name='AllowMissingArray', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MatchAnyValues: bpy.props.BoolProperty(name='MatchAnyValues', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ArrayName: bpy.props.StringProperty(name='ArrayName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_InputFieldType: bpy.props.IntProperty(name='InputFieldType', default=-1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputType: bpy.props.IntProperty(name='OutputType', default=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKCookieCutter(Node, PBVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_PointInterpolation: bpy.props.EnumProperty(name='PointInterpolation', default="MeshEdges", items=e_PointInterpolation_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKDeformPointSet(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_InitializeWeights: bpy.props.BoolProperty(name='InitializeWeights', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKDelaunay2D(Node, PBVTK_Node):
    ...
    m_RandomPointInsertion: bpy.props.BoolProperty(name='RandomPointInsertion', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ProjectionPlaneMode: bpy.props.IntProperty(name='ProjectionPlaneMode', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Alpha: bpy.props.FloatProperty(name='Alpha', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Offset: bpy.props.FloatProperty(name='Offset', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKDepthImageToPointCloud(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CullFarPoints: bpy.props.BoolProperty(name='CullFarPoints', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CullNearPoints: bpy.props.BoolProperty(name='CullNearPoints', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ProduceColorScalars: bpy.props.BoolProperty(name='ProduceColorScalars', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ProduceVertexCellArray: bpy.props.BoolProperty(name='ProduceVertexCellArray', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKExtractSelectedFrustum(Node, PBVTK_Node):
    ...
    m_ShowBounds: bpy.props.BoolProperty(name='ShowBounds', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ContainingCells: bpy.props.IntProperty(name='ContainingCells', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKExtractSelection(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_HyperTreeGridToUnstructuredGrid: bpy.props.BoolProperty(name='HyperTreeGridToUnstructuredGrid', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PreserveTopology: bpy.props.BoolProperty(name='PreserveTopology', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKFastSplatter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaxValue: bpy.props.FloatProperty(name='MaxValue', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinValue: bpy.props.FloatProperty(name='MinValue', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_LimitMode: bpy.props.EnumProperty(name='LimitMode', default="None", items=e_LimitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputDimensions: bpy.props.IntVectorProperty(name='OutputDimensions', default=[100, 100, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ModelBounds: bpy.props.FloatVectorProperty(name='ModelBounds', default=[0.0, -1.0, 0.0, -1.0, 0.0, -1.0], size=6, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKFitToHeightMapFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseHeightMapOffset: bpy.props.BoolProperty(name='UseHeightMapOffset', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_FittingStrategy: bpy.props.EnumProperty(name='FittingStrategy', default="PointProjection", items=e_FittingStrategy_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKGenericGlyph3DFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Clamping: bpy.props.BoolProperty(name='Clamping', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_GeneratePointIds: bpy.props.BoolProperty(name='GeneratePointIds', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Orient: bpy.props.BoolProperty(name='Orient', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Scaling: bpy.props.BoolProperty(name='Scaling', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PointIdsName: bpy.props.StringProperty(name='PointIdsName', default="InputPointIds", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ScaleFactor: bpy.props.FloatProperty(name='ScaleFactor', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_ColorMode: bpy.props.EnumProperty(name='ColorMode', default="ColorByScale", items=e_ColorMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_IndexMode: bpy.props.EnumProperty(name='IndexMode', default="Off", items=e_IndexMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_ScaleMode: bpy.props.EnumProperty(name='ScaleMode', default="ScaleByScalar", items=e_ScaleMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_Range: bpy.props.FloatVectorProperty(name='Range', default=[0.0, 1.0], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKGenericStreamTracer(Node, PBVTK_Node):
    ...
    m_MaximumError: bpy.props.FloatProperty(name='MaximumError', default=1e-06, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_RotationScale: bpy.props.FloatProperty(name='RotationScale', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    e_InitialIntegrationStepUnit: bpy.props.EnumProperty(name='InitialIntegrationStepUnit', default="CellLengthUnit", items=e_InitialIntegrationStepUnit_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    e_MaximumIntegrationStepUnit: bpy.props.EnumProperty(name='MaximumIntegrationStepUnit', default="CellLengthUnit", items=e_MaximumIntegrationStepUnit_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_MaximumPropagationUnit: bpy.props.EnumProperty(name='MaximumPropagationUnit', default="LengthUnit", items=e_MaximumPropagationUnit_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_MinimumIntegrationStepUnit: bpy.props.EnumProperty(name='MinimumIntegrationStepUnit', default="CellLengthUnit", items=e_MinimumIntegrationStepUnit_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKGlyph2D(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Clamping: bpy.props.BoolProperty(name='Clamping', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_FillCellData: bpy.props.BoolProperty(name='FillCellData', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_GeneratePointIds: bpy.props.BoolProperty(name='GeneratePointIds', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Orient: bpy.props.BoolProperty(name='Orient', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Scaling: bpy.props.BoolProperty(name='Scaling', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKHyperTreeGridProbeFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComputeTolerance: bpy.props.BoolProperty(name='ComputeTolerance', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassCellArrays: bpy.props.BoolProperty(name='PassCellArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseImplicitArrays: bpy.props.BoolProperty(name='UseImplicitArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidPointMaskArrayName: bpy.props.StringProperty(name='ValidPointMaskArrayName', default="vtkValidPointMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageAccumulate(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_IgnoreZero: bpy.props.BoolProperty(name='IgnoreZero', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComponentOrigin: bpy.props.FloatVectorProperty(name='ComponentOrigin', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComponentSpacing: bpy.props.FloatVectorProperty(name='ComponentSpacing', default=[1.0, 1.0, 1.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageBlend(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_BlendAlpha: bpy.props.BoolProperty(name='BlendAlpha', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CompoundAlpha: bpy.props.BoolProperty(name='CompoundAlpha', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_CompoundThreshold: bpy.props.FloatProperty(name='CompoundThreshold', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_BlendMode: bpy.props.EnumProperty(name='BlendMode', default="Normal", items=e_BlendMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageChangeInformation(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CenterImage: bpy.props.BoolProperty(name='CenterImage', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ExtentTranslation: bpy.props.IntVectorProperty(name='ExtentTranslation', default=[0, 0, 0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputExtentStart: bpy.props.IntVectorProperty(name='OutputExtentStart', default=[1000000000, 1000000000, 1000000000], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OriginScale: bpy.props.FloatVectorProperty(name='OriginScale', default=[1.0, 1.0, 1.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OriginTranslation: bpy.props.FloatVectorProperty(name='OriginTranslation', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputOrigin: bpy.props.FloatVectorProperty(name='OutputOrigin', default=[1e+30, 1e+30, 1e+30], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputSpacing: bpy.props.FloatVectorProperty(name='OutputSpacing', default=[1e+30, 1e+30, 1e+30], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SpacingScale: bpy.props.FloatVectorProperty(name='SpacingScale', default=[1.0, 1.0, 1.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageCheckerboard(Node, PBVTK_Node):
    ...
    e_SplitMode: bpy.props.EnumProperty(name='SplitMode', default="Slab", items=e_SplitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfDivisions: bpy.props.IntVectorProperty(name='NumberOfDivisions', default=[2, 2, 2], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageDataLIC2D(Node, PBVTK_Node):
    ...
    m_Steps: bpy.props.IntProperty(name='Steps', default=20, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageDifference(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AllowShift: bpy.props.BoolProperty(name='AllowShift', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_DesiredBytesPerPiece: bpy.props.IntProperty(name='DesiredBytesPerPiece', default=65536, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfThreads: bpy.props.IntProperty(name='NumberOfThreads', default=32, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Threshold: bpy.props.IntProperty(name='Threshold', default=105, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AverageThresholdFactor: bpy.props.FloatProperty(name='AverageThresholdFactor', default=0.65, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_SplitMode: bpy.props.EnumProperty(name='SplitMode', default="Slab", items=e_SplitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageHistogram(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AutomaticBinning: bpy.props.BoolProperty(name='AutomaticBinning', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_EnableSMP: bpy.props.BoolProperty(name='EnableSMP', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_GenerateHistogramImage: bpy.props.BoolProperty(name='GenerateHistogramImage', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_GlobalDefaultEnableSMP: bpy.props.BoolProperty(name='GlobalDefaultEnableSMP', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ActiveComponent: bpy.props.IntProperty(name='ActiveComponent', default=-1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DesiredBytesPerPiece: bpy.props.IntProperty(name='DesiredBytesPerPiece', default=65536, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaximumNumberOfBins: bpy.props.IntProperty(name='MaximumNumberOfBins', default=65536, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfBins: bpy.props.IntProperty(name='NumberOfBins', default=256, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfThreads: bpy.props.IntProperty(name='NumberOfThreads', default=32, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_BinOrigin: bpy.props.FloatProperty(name='BinOrigin', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_BinSpacing: bpy.props.FloatProperty(name='BinSpacing', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_HistogramImageScale: bpy.props.EnumProperty(name='HistogramImageScale', default="Linear", items=e_HistogramImageScale_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_SplitMode: bpy.props.EnumProperty(name='SplitMode', default="Slab", items=e_SplitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_HistogramImageSize: bpy.props.IntVectorProperty(name='HistogramImageSize', default=[256, 256], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageHistogramStatistics(Node, PBVTK_Node):
    ...
    m_HistogramImageSize: bpy.props.IntVectorProperty(name='HistogramImageSize', default=[256, 256], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AutoRangeExpansionFactors: bpy.props.FloatVectorProperty(name='AutoRangeExpansionFactors', default=[0.1, 0.1], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AutoRangePercentiles: bpy.props.FloatVectorProperty(name='AutoRangePercentiles', default=[1.0, 99.0], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageLogic(Node, PBVTK_Node):
    ...
    m_DesiredBytesPerPiece: bpy.props.IntProperty(name='DesiredBytesPerPiece', default=65536, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfThreads: bpy.props.IntProperty(name='NumberOfThreads', default=32, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutputTrueValue: bpy.props.FloatProperty(name='OutputTrueValue', default=255.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageMask(Node, PBVTK_Node):
    ...
    m_EnableSMP: bpy.props.BoolProperty(name='EnableSMP', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_GlobalDefaultEnableSMP: bpy.props.BoolProperty(name='GlobalDefaultEnableSMP', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NotMask: bpy.props.BoolProperty(name='NotMask', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DesiredBytesPerPiece: bpy.props.IntProperty(name='DesiredBytesPerPiece', default=65536, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfThreads: bpy.props.IntProperty(name='NumberOfThreads', default=32, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaskAlpha: bpy.props.FloatProperty(name='MaskAlpha', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_SplitMode: bpy.props.EnumProperty(name='SplitMode', default="Slab", items=e_SplitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageRectilinearWipe(Node, PBVTK_Node):
    ...
    m_NumberOfThreads: bpy.props.IntProperty(name='NumberOfThreads', default=32, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_SplitMode: bpy.props.EnumProperty(name='SplitMode', default="Slab", items=e_SplitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_Wipe: bpy.props.EnumProperty(name='Wipe', default="Quad", items=e_Wipe_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Axis: bpy.props.IntVectorProperty(name='Axis', default=[0, 1], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Position: bpy.props.IntVectorProperty(name='Position', default=[0, 0], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageSSIM(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ClampNegativeValues: bpy.props.BoolProperty(name='ClampNegativeValues', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_EnableSMP: bpy.props.BoolProperty(name='EnableSMP', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_GlobalDefaultEnableSMP: bpy.props.BoolProperty(name='GlobalDefaultEnableSMP', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DesiredBytesPerPiece: bpy.props.IntProperty(name='DesiredBytesPerPiece', default=65536, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfThreads: bpy.props.IntProperty(name='NumberOfThreads', default=32, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PatchRadius: bpy.props.FloatProperty(name='PatchRadius', default=6.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_SplitMode: bpy.props.EnumProperty(name='SplitMode', default="Slab", items=e_SplitMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumPieceSize: bpy.props.IntVectorProperty(name='MinimumPieceSize', default=[16, 1, 1], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKImageThresholdConnectivity(Node, PBVTK_Node):
    ...
    m_NeighborhoodFraction: bpy.props.FloatProperty(name='NeighborhoodFraction', default=0.5, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_OutValue: bpy.props.FloatProperty(name='OutValue', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SliceRangeX: bpy.props.IntVectorProperty(name='SliceRangeX', default=[-1000000000, 1000000000], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SliceRangeY: bpy.props.IntVectorProperty(name='SliceRangeY', default=[-1000000000, 1000000000], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SliceRangeZ: bpy.props.IntVectorProperty(name='SliceRangeZ', default=[-1000000000, 1000000000], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NeighborhoodRadius: bpy.props.FloatVectorProperty(name='NeighborhoodRadius', default=[0.0, 0.0, 0.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKJoinTables(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_LeftKey: bpy.props.StringProperty(name='LeftKey', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_RightKey: bpy.props.StringProperty(name='RightKey', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKMergeDataObjectFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_OutputField: bpy.props.EnumProperty(name='OutputField', default="DataObjectField", items=e_OutputField_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPResampleWithDataSet(Node, PBVTK_Node):
    ...
    m_ComputeTolerance: bpy.props.BoolProperty(name='ComputeTolerance', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MarkBlankPointsAndCells: bpy.props.BoolProperty(name='MarkBlankPointsAndCells', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassCellArrays: bpy.props.BoolProperty(name='PassCellArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPartialArrays: bpy.props.BoolProperty(name='PassPartialArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SnapToCellWithClosestPoint: bpy.props.BoolProperty(name='SnapToCellWithClosestPoint', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseBalancedPartitionForPointsLookup: bpy.props.BoolProperty(name='UseBalancedPartitionForPointsLookup', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseImplicitArrays: bpy.props.BoolProperty(name='UseImplicitArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Tolerance: bpy.props.FloatProperty(name='Tolerance', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKParallelCoordinatesHistogramRepresentation(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Selectable: bpy.props.BoolProperty(name='Selectable', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ShowOutliers: bpy.props.BoolProperty(name='ShowOutliers', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseCurves: bpy.props.BoolProperty(name='UseCurves', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_UseHistograms: bpy.props.BoolProperty(name='UseHistograms', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectionArrayName: bpy.props.StringProperty(name='SelectionArrayName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CurveResolution: bpy.props.IntProperty(name='CurveResolution', default=20, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_LabelRenderMode: bpy.props.IntProperty(name='LabelRenderMode', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfAxisLabels: bpy.props.IntProperty(name='NumberOfAxisLabels', default=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PreferredNumberOfOutliers: bpy.props.IntProperty(name='PreferredNumberOfOutliers', default=100, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SelectionType: bpy.props.IntProperty(name='SelectionType', default=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AngleBrushThreshold: bpy.props.FloatProperty(name='AngleBrushThreshold', default=0.03, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_FontSize: bpy.props.FloatProperty(name='FontSize', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_FunctionBrushThreshold: bpy.props.FloatProperty(name='FunctionBrushThreshold', default=0.1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_LineOpacity: bpy.props.FloatProperty(name='LineOpacity', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NumberOfHistogramBins: bpy.props.IntVectorProperty(name='NumberOfHistogramBins', default=[10, 10], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AxisColor: bpy.props.FloatVectorProperty(name='AxisColor', default=[1.0, 0.8, 0.3], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AxisLabelColor: bpy.props.FloatVectorProperty(name='AxisLabelColor', default=[1.0, 1.0, 1.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_HistogramLookupTableRange: bpy.props.FloatVectorProperty(name='HistogramLookupTableRange', default=[0.0, 10.0], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_LineColor: bpy.props.FloatVectorProperty(name='LineColor', default=[1.0, 1.0, 1.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKParticlePathFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComputeVorticity: bpy.props.BoolProperty(name='ComputeVorticity', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DisableResetCache: bpy.props.BoolProperty(name='DisableResetCache', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_EnableParticleWriting: bpy.props.BoolProperty(name='EnableParticleWriting', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ForceSerialExecution: bpy.props.BoolProperty(name='ForceSerialExecution', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ParticleFileName: bpy.props.StringProperty(name='ParticleFileName', default="", subtype='FILE_PATH', update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ForceReinjectionEveryNSteps: bpy.props.IntProperty(name='ForceReinjectionEveryNSteps', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_IntegratorType: bpy.props.IntProperty(name='IntegratorType', default=1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_StaticSeeds: bpy.props.IntProperty(name='StaticSeeds', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_RotationScale: bpy.props.FloatProperty(name='RotationScale', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_StartTime: bpy.props.FloatProperty(name='StartTime', default=nan, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_TerminalSpeed: bpy.props.FloatProperty(name='TerminalSpeed', default=1e-12, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_TerminationTime: bpy.props.FloatProperty(name='TerminationTime', default=nan, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_MeshOverTime: bpy.props.EnumProperty(name='MeshOverTime', default="Different", items=e_MeshOverTime_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPointInterpolator(Node, PBVTK_Node):
    ...
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PromoteOutputArrays: bpy.props.BoolProperty(name='PromoteOutputArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidPointsMaskArrayName: bpy.props.StringProperty(name='ValidPointsMaskArrayName', default="vtkValidPointMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NullValue: bpy.props.FloatProperty(name='NullValue', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_NullPointsStrategy: bpy.props.EnumProperty(name='NullPointsStrategy', default="NullValue", items=e_NullPointsStrategy_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPointInterpolator2D(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_InterpolateZ: bpy.props.BoolProperty(name='InterpolateZ', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassCellArrays: bpy.props.BoolProperty(name='PassCellArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PromoteOutputArrays: bpy.props.BoolProperty(name='PromoteOutputArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidPointsMaskArrayName: bpy.props.StringProperty(name='ValidPointsMaskArrayName', default="vtkValidPointMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ZArrayName: bpy.props.StringProperty(name='ZArrayName', default="Elevation", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NullValue: bpy.props.FloatProperty(name='NullValue', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_NullPointsStrategy: bpy.props.EnumProperty(name='NullPointsStrategy', default="NullValue", items=e_NullPointsStrategy_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKPolyDataEdgeConnectivityFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_BarrierEdges: bpy.props.BoolProperty(name='BarrierEdges', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CellRegionAreas: bpy.props.BoolProperty(name='CellRegionAreas', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_LargeRegionThreshold: bpy.props.FloatProperty(name='LargeRegionThreshold', default=0.1, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    e_RegionGrowing: bpy.props.EnumProperty(name='RegionGrowing', default="LargeRegions", items=e_RegionGrowing_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_BarrierEdgeLength: bpy.props.FloatVectorProperty(name='BarrierEdgeLength', default=[1e+30, 1e+30], size=2, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKProbeLineFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_AggregateAsPolyData: bpy.props.BoolProperty(name='AggregateAsPolyData', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComputeTolerance: bpy.props.BoolProperty(name='ComputeTolerance', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassCellArrays: bpy.props.BoolProperty(name='PassCellArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPartialArrays: bpy.props.BoolProperty(name='PassPartialArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_LineResolution: bpy.props.IntProperty(name='LineResolution', default=1000, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SamplingPattern: bpy.props.IntProperty(name='SamplingPattern', default=0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Tolerance: bpy.props.FloatProperty(name='Tolerance', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKProbePolyhedron(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ProbeCellData: bpy.props.BoolProperty(name='ProbeCellData', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ProbePointData: bpy.props.BoolProperty(name='ProbePointData', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKProgrammableGlyphFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_ColorMode: bpy.props.EnumProperty(name='ColorMode', default="ColorByInput", items=e_ColorMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKProjectedTerrainPath(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaximumNumberOfLines: bpy.props.IntProperty(name='MaximumNumberOfLines', default=1000000000, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_HeightOffset: bpy.props.FloatProperty(name='HeightOffset', default=10.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_HeightTolerance: bpy.props.FloatProperty(name='HeightTolerance', default=10.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_ProjectionMode: bpy.props.EnumProperty(name='ProjectionMode', default="Simple", items=e_ProjectionMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSPHInterpolator(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ComputeShepardSum: bpy.props.BoolProperty(name='ComputeShepardSum', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassCellArrays: bpy.props.BoolProperty(name='PassCellArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassFieldArrays: bpy.props.BoolProperty(name='PassFieldArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_PromoteOutputArrays: bpy.props.BoolProperty(name='PromoteOutputArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ShepardNormalization: bpy.props.BoolProperty(name='ShepardNormalization', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_CutoffArrayName: bpy.props.StringProperty(name='CutoffArrayName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_DensityArrayName: bpy.props.StringProperty(name='DensityArrayName', default="Rho", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MassArrayName: bpy.props.StringProperty(name='MassArrayName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ShepardSumArrayName: bpy.props.StringProperty(name='ShepardSumArrayName', default="Shepard Summation", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidPointsMaskArrayName: bpy.props.StringProperty(name='ValidPointsMaskArrayName', default="vtkValidPointMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_NullValue: bpy.props.FloatProperty(name='NullValue', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_NullPointsStrategy: bpy.props.EnumProperty(name='NullPointsStrategy', default="NullValue", items=e_NullPointsStrategy_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSelectEnclosedPoints(Node, PBVTK_Node):
    ...
    m_InsideOut: bpy.props.BoolProperty(name='InsideOut', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Tolerance: bpy.props.FloatProperty(name='Tolerance', default=0.0001, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKStreamSurface(Node, PBVTK_Node):
    ...
    m_ComputeVorticity: bpy.props.BoolProperty(name='ComputeVorticity', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ForceSerialExecution: bpy.props.BoolProperty(name='ForceSerialExecution', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_SurfaceStreamlines: bpy.props.BoolProperty(name='SurfaceStreamlines', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_UseLocalSeedSource: bpy.props.BoolProperty(name='UseLocalSeedSource', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    ...
    m_MaximumError: bpy.props.FloatProperty(name='MaximumError', default=1e-06, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaximumIntegrationStep: bpy.props.FloatProperty(name='MaximumIntegrationStep', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaximumPropagation: bpy.props.FloatProperty(name='MaximumPropagation', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MinimumIntegrationStep: bpy.props.FloatProperty(name='MinimumIntegrationStep', default=0.01, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_RotationScale: bpy.props.FloatProperty(name='RotationScale', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_TerminalSpeed: bpy.props.FloatProperty(name='TerminalSpeed', default=1e-12, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_IntegrationDirection: bpy.props.EnumProperty(name='IntegrationDirection', default="Forward", items=e_IntegrationDirection_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_IntegratorType: bpy.props.EnumProperty(name='IntegratorType', default="RungeKutta2", items=e_IntegratorType_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSubPixelPositionEdgels(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_TargetFlag: bpy.props.BoolProperty(name='TargetFlag', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_TargetValue: bpy.props.FloatProperty(name='TargetValue', default=0.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKSynchronizeTimeFilter(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_RelativeTolerance: bpy.props.FloatProperty(name='RelativeTolerance', default=1e-05, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKTensorGlyph(Node, PBVTK_Node):
    ...
    m_AbortOutput: bpy.props.BoolProperty(name='AbortOutput', default=False, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ClampScaling: bpy.props.BoolProperty(name='ClampScaling', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ColorGlyphs: bpy.props.BoolProperty(name='ColorGlyphs', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ExtractEigenvalues: bpy.props.BoolProperty(name='ExtractEigenvalues', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Scaling: bpy.props.BoolProperty(name='Scaling', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Symmetric: bpy.props.BoolProperty(name='Symmetric', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ThreeGlyphs: bpy.props.BoolProperty(name='ThreeGlyphs', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_Length: bpy.props.FloatProperty(name='Length', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_MaxScaleFactor: bpy.props.FloatProperty(name='MaxScaleFactor', default=100.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ScaleFactor: bpy.props.FloatProperty(name='ScaleFactor', default=1.0, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_ColorMode: bpy.props.EnumProperty(name='ColorMode', default="Scalars", items=e_ColorMode_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKTrimmedExtrusionFilter(Node, PBVTK_Node):
    ...
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_CappingStrategy: bpy.props.EnumProperty(name='CappingStrategy', default="MaximumDistance", items=e_CappingStrategy_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    e_ExtrusionStrategy: bpy.props.EnumProperty(name='ExtrusionStrategy', default="BoundaryEdges", items=e_ExtrusionStrategy_items, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ExtrusionDirection: bpy.props.FloatVectorProperty(name='ExtrusionDirection', default=[0.0, 0.0, 1.0], size=3, update=PBVTK_Node.outdate_vtk_status) #type: ignore
...
class VTKmProbe(Node, PBVTK_Node):
    ...
    m_PassPointArrays: bpy.props.BoolProperty(name='PassPointArrays', default=True, update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ObjectName: bpy.props.StringProperty(name='ObjectName', default="", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidCellMaskArrayName: bpy.props.StringProperty(name='ValidCellMaskArrayName', default="vtkValidCellMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
    m_ValidPointMaskArrayName: bpy.props.StringProperty(name='ValidPointMaskArrayName', default="vtkValidPointMask", update=PBVTK_Node.outdate_vtk_status) #type: ignore
