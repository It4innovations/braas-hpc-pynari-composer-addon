...
class VTKBSplineTransform(Node, PBVTK_Node):
    ...
    m_InverseIterations: bpy.props.IntProperty(name='InverseIterations', default=500) #type: ignore
    m_DisplacementScale: bpy.props.FloatProperty(name='DisplacementScale', default=1.0) #type: ignore
    m_InverseTolerance: bpy.props.FloatProperty(name='InverseTolerance', default=1e-06) #type: ignore
    e_BorderMode: bpy.props.EnumProperty(name='BorderMode', default="Edge", items=e_BorderMode_items) #type: ignore
...
class VTKCylindricalTransform(Node, PBVTK_Node):
    ...
    m_InverseIterations: bpy.props.IntProperty(name='InverseIterations', default=500) #type: ignore
    m_InverseTolerance: bpy.props.FloatProperty(name='InverseTolerance', default=0.001) #type: ignore
...
class VTKGridTransform(Node, PBVTK_Node):
    ...
    m_InverseIterations: bpy.props.IntProperty(name='InverseIterations', default=500) #type: ignore
    m_DisplacementScale: bpy.props.FloatProperty(name='DisplacementScale', default=1.0) #type: ignore
    m_DisplacementShift: bpy.props.FloatProperty(name='DisplacementShift', default=0.0) #type: ignore
    m_InverseTolerance: bpy.props.FloatProperty(name='InverseTolerance', default=0.01) #type: ignore
...
class VTKIterativeClosestPointTransform(Node, PBVTK_Node):
    ...
    m_CheckMeanDistance: bpy.props.BoolProperty(name='CheckMeanDistance', default=True) #type: ignore
    m_StartByMatchingCentroids: bpy.props.BoolProperty(name='StartByMatchingCentroids', default=True) #type: ignore
    m_MaximumNumberOfIterations: bpy.props.IntProperty(name='MaximumNumberOfIterations', default=50) #type: ignore
    m_MaximumNumberOfLandmarks: bpy.props.IntProperty(name='MaximumNumberOfLandmarks', default=200) #type: ignore
    m_MaximumMeanDistance: bpy.props.FloatProperty(name='MaximumMeanDistance', default=0.01) #type: ignore
    e_MeanDistanceMode: bpy.props.EnumProperty(name='MeanDistanceMode', default="RMS", items=e_MeanDistanceMode_items) #type: ignore
...
class VTKLandmarkTransform(Node, PBVTK_Node):
    ...
    e_Mode: bpy.props.EnumProperty(name='Mode', default="Similarity", items=e_Mode_items) #type: ignore
...
class VTKThinPlateSplineTransform(Node, PBVTK_Node):
    ...
    m_RegularizeBulkTransform: bpy.props.BoolProperty(name='RegularizeBulkTransform', default=True) #type: ignore
    m_InverseIterations: bpy.props.IntProperty(name='InverseIterations', default=500) #type: ignore
    m_InverseTolerance: bpy.props.FloatProperty(name='InverseTolerance', default=0.001) #type: ignore
    m_Sigma: bpy.props.FloatProperty(name='Sigma', default=1.0) #type: ignore
    e_Basis: bpy.props.EnumProperty(name='Basis', default="R2LogR", items=e_Basis_items) #type: ignore
